...
Object.defineProperty(exports, "SamplerInfo", {
  enumerable: true,
  get: function () {
    return _define.SamplerInfo;
  }
});
...
exports.passParams = exports.getMemoryAccessFlag = exports.isPaddedMatrix = exports.isNormalized = exports.getDescriptorType = exports.getShaderStage = exports.getFormat = exports.formatMap = exports.typeMap = exports.isSampler = exports.effectStructure = void 0;
...
var _sampler = require("../../cocos/core/gfx/base/states/sampler.js");
...
typeMap[typeMap.samplerCube = _define.Type.SAMPLER_CUBE] = 'samplerCube';
typeMap[typeMap.sampler = _define.Type.SAMPLER] = 'sampler';
typeMap[typeMap.texture1D = _define.Type.TEXTURE1D] = 'texture1D';
typeMap[typeMap.texture1DArray = _define.Type.TEXTURE1D_ARRAY] = 'texture1DArray';
typeMap[typeMap.texture2D = _define.Type.TEXTURE2D] = 'texture2D';
typeMap[typeMap.texture2DArray = _define.Type.TEXTURE2D_ARRAY] = 'texture2DArray';
typeMap[typeMap.texture3D = _define.Type.TEXTURE3D] = 'texture3D';
typeMap[typeMap.textureCube = _define.Type.TEXTURE_CUBE] = 'textureCube';
typeMap[typeMap.image1D = _define.Type.IMAGE1D] = 'image1D';
typeMap[typeMap.image1DArray = _define.Type.IMAGE1D_ARRAY] = 'image1DArray';
typeMap[typeMap.image2D = _define.Type.IMAGE2D] = 'image2D';
typeMap[typeMap.image2DArray = _define.Type.IMAGE2D_ARRAY] = 'image2DArray';
typeMap[typeMap.image3D = _define.Type.IMAGE3D] = 'image3D';
typeMap[typeMap.imageCube = _define.Type.IMAGE_CUBE] = 'imageCube';
typeMap[typeMap.subpassInput = _define.Type.SUBPASS_INPUT] = 'subpassInput'; // variations
...
const getFormat = name => _define.Format[name.toUpperCase()];

exports.getFormat = getFormat;

const getShaderStage = name => _define.ShaderStageFlagBit[name.toUpperCase()];

exports.getShaderStage = getShaderStage;

const getDescriptorType = name => _define.DescriptorType[name.toUpperCase()];
...
const getMemoryAccessFlag = access => {
  if (access === 'writeonly') {
    return _define.MemoryAccessBit.WRITE_ONLY;
  }

  if (access === 'readonly') {
    return _define.MemoryAccessBit.READ_ONLY;
  }

  return _define.MemoryAccessBit.READ_WRITE;
};

exports.getMemoryAccessFlag = getMemoryAccessFlag;
const passParams = {
  // color mask
