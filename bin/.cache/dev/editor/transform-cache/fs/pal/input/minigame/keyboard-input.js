...
class KeyboardInputSource {
  ...
  constructor() {
    ...
    if (_systemInfo.systemInfo.hasFeature(_index3.Feature.EVENT_KEYBOARD)) {
      this._registerEvent();
    }
  }
  ...
  _registerEvent() {
    ...
    (_minigame$wx = _minigame.minigame.wx) === null || _minigame$wx === void 0 ? void 0 : (_minigame$wx$onKeyDow = _minigame$wx.onKeyDown) === null || _minigame$wx$onKeyDow === void 0 ? void 0 : _minigame$wx$onKeyDow.call(_minigame$wx, res => {
      const keyCode = getKeyCode(res.code);

      if (!this._keyStateMap[keyCode]) {
        const eventKeyDown = this._getInputEvent(res, _eventEnum.InputEventType.KEY_DOWN);

        this._eventTarget.emit(_eventEnum.InputEventType.KEY_DOWN, eventKeyDown);
      } else {
        const eventKeyPressing = this._getInputEvent(res, _eventEnum.InputEventType.KEY_PRESSING);
    ...
    (_minigame$wx2 = _minigame.minigame.wx) === null || _minigame$wx2 === void 0 ? void 0 : (_minigame$wx2$onKeyUp = _minigame$wx2.onKeyUp) === null || _minigame$wx2$onKeyUp === void 0 ? void 0 : _minigame$wx2$onKeyUp.call(_minigame$wx2, res => {
      const keyCode = getKeyCode(res.code);

      const eventKeyUp = this._getInputEvent(res, _eventEnum.InputEventType.KEY_UP);
