...
class SystemInfo extends _index.EventTarget {
  constructor() {
    ...
    this.browserVersion = tmp ? tmp[4] : ''; // init capability
    ...
    const supportMouse = !_internal253Aconstants.EDITOR && document.documentElement.onmouseup !== undefined;
    this._featureMap = {
      [_index2.Feature.WEBP]: supportWebp,
      [_index2.Feature.IMAGE_BITMAP]: supportImageBitmap,
      [_index2.Feature.WEB_VIEW]: true,
      [_index2.Feature.VIDEO_PLAYER]: true,
      [_index2.Feature.SAFE_AREA]: false,
      [_index2.Feature.INPUT_TOUCH]: supportTouch,
      [_index2.Feature.EVENT_KEYBOARD]: document.documentElement.onkeyup !== undefined,
      [_index2.Feature.EVENT_MOUSE]: supportMouse,
      [_index2.Feature.EVENT_TOUCH]: supportTouch || supportMouse,
      [_index2.Feature.EVENT_ACCELEROMETER]: window.DeviceMotionEvent !== undefined || window.DeviceOrientationEvent !== undefined
    };
