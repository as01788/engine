...
var _base64Values = _interopRequireDefault(require("./base64-values.js"));
...
Base64.decode = function Jacob__Codec__Base64__decode(input) {
  ...
  while (i < input.length) {
    enc1 = _base64Values.default[input.charCodeAt(i++)];
    enc2 = _base64Values.default[input.charCodeAt(i++)];
    enc3 = _base64Values.default[input.charCodeAt(i++)];
    enc4 = _base64Values.default[input.charCodeAt(i++)];
    chr1 = enc1 << 2 | enc2 >> 4;
