...
let Burst = (_dec = (0, _index.ccclass)('cc.Burst'), _dec2 = (0, _index.type)(_curveRange.default), _dec3 = (0, _index.range)([0, 1]), _dec(_class = (_class2 = (_temp = class Burst {
  /**
...
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "count", [_dec2, _index.serializable, _dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
