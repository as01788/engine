...
exports.Mode = Mode;
let CurveRange = (_dec = (0, _index.ccclass)('cc.CurveRange'), _dec2 = (0, _index.type)(Mode), _dec3 = (0, _index.type)(_index4.RealCurve), _dec4 = (0, _index.type)(_index4.RealCurve), _dec5 = (0, _index.type)(_index4.RealCurve), _dec(_class = (_class2 = (_temp = _class3 = class CurveRange {
  /**
   * @zh 曲线类型[[Mode]]。
   */
  ...
  constructor() {
    ...
    this._curve = new _curve.AnimationCurve(this.spline);
    this._curveMin = new _curve.AnimationCurve(this.splineMin);
    this._curveMax = new _curve.AnimationCurve(this.splineMax);
  }
  ...
  evaluate(time, rndRatio) {
    switch (this.mode) {
      ...
      case Mode.TwoCurves:
        return (0, _index2.lerp)(this.splineMin.evaluate(time), this.splineMax.evaluate(time), rndRatio) * this.multiplier;
  ...
  writable: true,
  initializer: function () {
    return (0, _curve.constructLegacyCurveAndConvert)();
  }
...
function packTexture(data, width, height) {
  const image = new _index4.ImageAsset({
    width,
    height,
    _data: data,
    _compressed: false,
