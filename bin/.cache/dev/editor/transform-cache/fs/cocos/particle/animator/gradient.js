  ...
  getAlpha(time) {
    ...
    if (this.alphaKeys.length > 1) {
      ...
      if (time < this.alphaKeys[0].time) {
        return (0, _index2.lerp)(basicAlpha, this.alphaKeys[0].alpha, time / this.alphaKeys[0].time);
      } else if (time > this.alphaKeys[lastIndex].time) {
        return (0, _index2.lerp)(this.alphaKeys[lastIndex].alpha, basicAlpha, (time - this.alphaKeys[lastIndex].time) / (1 - this.alphaKeys[lastIndex].time));
      }
