...
let TextureAnimationModule = (_dec = (0, _index.ccclass)('cc.TextureAnimationModule'), _dec2 = (0, _index.formerlySerializedAs)('numTilesX'), _dec3 = (0, _index.formerlySerializedAs)('numTilesY'), _dec4 = (0, _index.displayOrder)(0), _dec5 = (0, _index.type)(Mode), _dec6 = (0, _index.type)(Mode), _dec7 = (0, _index.displayOrder)(1), _dec8 = (0, _index.tooltip)('i18n:textureAnimationModule.mode'), _dec9 = (0, _index.displayOrder)(2), _dec10 = (0, _index.tooltip)('i18n:textureAnimationModule.numTilesX'), _dec11 = (0, _index.displayOrder)(3), _dec12 = (0, _index.tooltip)('i18n:textureAnimationModule.numTilesY'), _dec13 = (0, _index.type)(Animation), _dec14 = (0, _index.displayOrder)(4), _dec15 = (0, _index.tooltip)('i18n:textureAnimationModule.animation'), _dec16 = (0, _index.type)(_curveRange.default), _dec17 = (0, _index.range)([0, 1]), _dec18 = (0, _index.displayOrder)(7), _dec19 = (0, _index.tooltip)('i18n:textureAnimationModule.frameOverTime'), _dec20 = (0, _index.type)(_curveRange.default), _dec21 = (0, _index.range)([0, 1]), _dec22 = (0, _index.displayOrder)(8), _dec23 = (0, _index.tooltip)('i18n:textureAnimationModule.startFrame'), _dec24 = (0, _index.displayOrder)(9), _dec25 = (0, _index.tooltip)('i18n:textureAnimationModule.cycleCount'), _dec26 = (0, _index.displayOrder)(5), _dec27 = (0, _index.tooltip)('i18n:textureAnimationModule.randomRow'), _dec28 = (0, _index.displayOrder)(6), _dec29 = (0, _index.tooltip)('i18n:textureAnimationModule.rowIndex'), _dec(_class = (_class2 = (_temp = class TextureAnimationModule extends _particle.ParticleModuleBase {
  constructor(...args) {
    super(...args);
...
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "frameOverTime", [_dec16, _index.serializable, _dec17, _dec18, _dec19], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "startFrame", [_dec20, _index.serializable, _dec21, _dec22, _dec23], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "cycleCount", [_index.serializable, _dec24, _dec25], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "randomRow", [_index.serializable, _dec26, _dec27], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "rowIndex", [_index.serializable, _dec28, _dec29], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
