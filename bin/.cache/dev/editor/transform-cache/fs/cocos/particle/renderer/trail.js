...
let TrailModule = (_dec = (0, _index.ccclass)('cc.TrailModule'), _dec2 = (0, _index.displayOrder)(0), _dec3 = (0, _index.type)(_enum.TrailMode), _dec4 = (0, _index.displayOrder)(1), _dec5 = (0, _index.tooltip)('i18n:trailSegment.mode'), _dec6 = (0, _index.type)(_curveRange.default), _dec7 = (0, _index.range)([0, 1]), _dec8 = (0, _index.displayOrder)(3), _dec9 = (0, _index.tooltip)('i18n:trailSegment.lifeTime'), _dec10 = (0, _index.displayOrder)(5), _dec11 = (0, _index.tooltip)('i18n:trailSegment.minParticleDistance'), _dec12 = (0, _index.type)(_enum.Space), _dec13 = (0, _index.displayOrder)(6), _dec14 = (0, _index.tooltip)('i18n:trailSegment.space'), _dec15 = (0, _index.type)(_enum.TextureMode), _dec16 = (0, _index.displayOrder)(8), _dec17 = (0, _index.tooltip)('i18n:trailSegment.textureMode'), _dec18 = (0, _index.displayOrder)(9), _dec19 = (0, _index.tooltip)('i18n:trailSegment.widthFromParticle'), _dec20 = (0, _index.type)(_curveRange.default), _dec21 = (0, _index.range)([0, 1]), _dec22 = (0, _index.displayOrder)(10), _dec23 = (0, _index.tooltip)('i18n:trailSegment.widthRatio'), _dec24 = (0, _index.displayOrder)(11), _dec25 = (0, _index.tooltip)('i18n:trailSegment.colorFromParticle'), _dec26 = (0, _index.type)(_gradientRange.default), _dec27 = (0, _index.displayOrder)(12), _dec28 = (0, _index.tooltip)('i18n:trailSegment.colorOverTrail'), _dec29 = (0, _index.type)(_gradientRange.default), _dec30 = (0, _index.displayOrder)(13), _dec31 = (0, _index.tooltip)('i18n:trailSegment.colorOvertime'), _dec32 = (0, _index.type)(_enum.Space), _dec(_class = (_class2 = (_temp = class TrailModule {
  /**
   * 是否启用。
   */
  get enable() {
  ...
  onInit(ps) {
    ...
    this._trailSegments = new _index4.Pool(() => new TrailSegment(10), Math.ceil(psRate * duration), obj => obj.trailElements.length = 0);
  ...
  updateRenderData() {
    ...
    for (const p of this._particleTrail.keys()) {
      ...
      if (trailModel) {
        trailModel.node.invalidateChildren(_nodeEnum.TransformBit.POSITION);
      }
  ...
  rebuild() {
    ...
    const indexBuffer = device.createBuffer(new _index2.BufferInfo(_index2.BufferUsageBit.INDEX | _index2.BufferUsageBit.TRANSFER_DST, _index2.MemoryUsageBit.HOST | _index2.MemoryUsageBit.DEVICE, Math.max(1, this._trailNum) * 6 * Uint16Array.BYTES_PER_ELEMENT, Uint16Array.BYTES_PER_ELEMENT));
...
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "lifeTime", [_dec6, _index.serializable, _dec7, _dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _applyDecoratedDescriptor(_class2.prototype, "minParticleDistance", [_dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "minParticleDistance"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "space", [_dec12, _dec13, _dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "space"), _class2.prototype), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "existWithParticles", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "textureMode", [_dec15, _index.serializable, _dec16, _dec17], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "widthFromParticle", [_index.serializable, _dec18, _dec19], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "widthRatio", [_dec20, _index.serializable, _dec21, _dec22, _dec23], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "colorFromParticle", [_index.serializable, _dec24, _dec25], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "colorOverTrail", [_dec26, _index.serializable, _dec27, _dec28], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "colorOvertime", [_dec29, _index.serializable, _dec30, _dec31], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "_space", [_dec32], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
