...
let RichText = (_dec = (0, _index.ccclass)('cc.RichText'), _dec2 = (0, _index.help)('i18n:cc.RichText'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('2D/RichText'), _dec5 = (0, _index.tooltip)('i18n:richtext.string'), _dec6 = (0, _index.type)(_label.HorizontalTextAlignment), _dec7 = (0, _index.tooltip)('i18n:richtext.horizontal_align'), _dec8 = (0, _index.tooltip)('i18n:richtext.font_size'), _dec9 = (0, _index.tooltip)('i18n:richtext.font_family'), _dec10 = (0, _index.type)(_index2.Font), _dec11 = (0, _index.tooltip)('i18n:richtext.font'), _dec12 = (0, _index.tooltip)('i18n:richtext.use_system_font'), _dec13 = (0, _index.type)(_label.CacheMode), _dec14 = (0, _index.tooltip)('i18n:richtext.cache_mode'), _dec15 = (0, _index.tooltip)('i18n:richtext.max_width'), _dec16 = (0, _index.tooltip)('i18n:richtext.line_height'), _dec17 = (0, _index.type)(_index2.SpriteAtlas), _dec18 = (0, _index.tooltip)('i18n:richtext.image_atlas'), _dec19 = (0, _index.tooltip)('i18n:richtext.handleTouchEvent'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = _class3 = class RichText extends _index6.UIComponent {
  ...
  onLoad() {
    this.node.on(_nodeEvent.NodeEventType.LAYER_CHANGED, this._applyLayer, this);
  }
  ...
  start() {
    ...
    this.node.on(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._updateRichTextPosition, this);
  }
  ...
  onDestroy() {
    ...
    this.node.off(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._updateRichTextPosition, this);
    this.node.off(_nodeEvent.NodeEventType.LAYER_CHANGED, this._applyLayer, this);
  }
  ...
  _resetLabelState(label) {
    ...
    label.color = _index4.Color.WHITE;
    label.isBold = false;
