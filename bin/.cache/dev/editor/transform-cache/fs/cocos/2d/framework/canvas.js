...
let Canvas = (_dec = (0, _index.ccclass)('cc.Canvas'), _dec2 = (0, _index.help)('i18n:cc.Canvas'), _dec3 = (0, _index.executionOrder)(100), _dec4 = (0, _index.menu)('UI/Canvas'), _dec5 = (0, _index.type)(_cameraComponent.Camera), _dec6 = (0, _index.tooltip)('i18n:canvas.camera'), _dec7 = (0, _index.tooltip)('i18n:canvas.align'), _dec8 = (0, _index.type)(_cameraComponent.Camera), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _index.executeInEditMode)(_class = (0, _index.disallowMultiple)(_class = (_class2 = (_temp = class Canvas extends _renderRoot2d.RenderRoot2D {
  ...
  __preload() {
    ...
    if (!_internal253Aconstants.EDITOR) {
      if (this._cameraComponent) {
        ...
        this._cameraComponent.node.on(_cameraComponent.Camera.TARGET_TEXTURE_CHANGE, this._thisOnCameraResized);
      }
    }
    ...
    this.node.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._thisOnCameraResized);
  }

  onEnable() {
    super.onEnable();

    if (!_internal253Aconstants.EDITOR && this._cameraComponent) {
      this._cameraComponent.node.on(_cameraComponent.Camera.TARGET_TEXTURE_CHANGE, this._thisOnCameraResized);
    }
  }
  ...
  onDisable() {
    ...
    if (this._cameraComponent) {
      this._cameraComponent.node.off(_cameraComponent.Camera.TARGET_TEXTURE_CHANGE, this._thisOnCameraResized);
    }
  }
  ...
  onDestroy() {
    ...
    this.node.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._thisOnCameraResized);
  }
  ...
  _onResizeCamera() {
    if (this._cameraComponent && this._alignCanvasWithScreen) {
      if (this._cameraComponent.targetTexture) {
        ...
        const size = _index3.screen.windowSize;
        this._cameraComponent.orthoHeight = size.height / _view.view.getScaleY() / 2;
      }
