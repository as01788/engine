...
class DynamicAtlasManager {
  ...
  insertSpriteFrame(spriteFrame) {
    ...
    if (sampler.minFilter !== _assetEnum.Filter.LINEAR || sampler.magFilter !== _assetEnum.Filter.LINEAR || sampler.mipFilter !== _assetEnum.Filter.NONE) {
      return null;
    }
  ...
  */
  ...
  deleteAtlasSpriteFrame(spriteFrame) {
    ...
    for (let i = this._atlases.length - 1; i >= 0; i--) {
      ...
      _js.js.array.fastRemove(atlas._innerSpriteFrames, spriteFrame);
    }
