 ...
 */
let UIOpacity = (_dec = (0, _index.ccclass)('cc.UIOpacity'), _dec2 = (0, _index.help)('i18n:cc.UIOpacity'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/UIOpacity'), _dec5 = (0, _index.tooltip)('i18n:UIOpacity.opacity'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = class UIOpacity extends _component.Component {
  constructor(...args) {
    super(...args);
...
}, _temp), (_applyDecoratedDescriptor(_class2.prototype, "opacity", [_index.editable, _dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "opacity"), _class2.prototype), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "_opacity", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
