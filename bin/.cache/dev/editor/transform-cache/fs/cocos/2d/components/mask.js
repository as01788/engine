...
let Mask = (_dec = (0, _index.ccclass)('cc.Mask'), _dec2 = (0, _index.help)('i18n:cc.Mask'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('2D/Mask'), _dec5 = (0, _index.type)(MaskType), _dec6 = (0, _index.displayOrder)(10), _dec7 = (0, _index.tooltip)('i18n:mask.type'), _dec8 = (0, _index.displayOrder)(14), _dec9 = (0, _index.tooltip)('i18n:mask.inverted'), _dec10 = (0, _index.visible)(function () {
  ...
  onDestroy() {
    ...
    if (this._clearModel && this._clearModelMesh) {
      _index3.director.root.destroyModel(this._clearModel);
  ...
  _createGraphics() {
    if (!this._graphics) {
      ...
      graphics._objFlags |= _index3.CCObject.Flags.IsOnLoadCalled; // hack for destroy
  ...
  _createClearModel() {
    if (!this._clearModel) {
      const mtl = _index3.builtinResMgr.get('default-clear-stencil');

      this._clearStencilMtl = new _index5.MaterialInstance({
        parent: mtl,
        owner: this,
        subModelIdx: 0
      });
      this._clearModel = _index3.director.root.createModel(_index5.scene.Model);
      ...
      const vertexBuffer = gfxDevice.createBuffer(new _index4.BufferInfo(_index4.BufferUsageBit.VERTEX | _index4.BufferUsageBit.TRANSFER_DST, _index4.MemoryUsageBit.DEVICE, 4 * stride, stride));
      const vb = new Float32Array([-1, -1, 0, 1, -1, 0, -1, 1, 0, 1, 1, 0]);
      vertexBuffer.update(vb);
      const indexBuffer = gfxDevice.createBuffer(new _index4.BufferInfo(_index4.BufferUsageBit.INDEX | _index4.BufferUsageBit.TRANSFER_DST, _index4.MemoryUsageBit.DEVICE, 6 * Uint16Array.BYTES_PER_ELEMENT, Uint16Array.BYTES_PER_ELEMENT));
      const ib = new Uint16Array([0, 1, 2, 2, 1, 3]);
      indexBuffer.update(ib);
      this._clearModelMesh = new _index3.RenderingSubMesh([vertexBuffer], _vertexFormat.vfmt, _index4.PrimitiveMode.TRIANGLE_LIST, indexBuffer);
  ...
  _updateMaterial() {
    if (this._graphics) {
      ...
      if (this._type === MaskType.IMAGE_STENCIL) {
        mat = _index3.builtinResMgr.get('ui-alpha-test-material');
        target.setMaterial(mat, 0);
        mat = target.getMaterialInstance(0);
        mat.setProperty('alphaThreshold', this._alphaThreshold);
      } else {
        mat = _index3.builtinResMgr.get('ui-graphics-material');
        target.setMaterial(mat, 0);
...
exports.Mask = Mask;
_nodeEventProcessor.NodeEventProcessor._maskComp = Mask;
