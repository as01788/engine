...
let SphereLight = (_dec = (0, _index.ccclass)('cc.SphereLight'), _dec2 = (0, _index.help)('i18n:cc.SphereLight'), _dec3 = (0, _index.menu)('Light/SphereLight'), _dec4 = (0, _index.formerlySerializedAs)('_luminance'), _dec5 = (0, _index.tooltip)('i18n:lights.luminous_flux'), _dec6 = (0, _index.tooltip)('i18n:lights.luminance'), _dec7 = (0, _index.type)(_lightComponent.PhotometricTerm), _dec8 = (0, _index.tooltip)('i18n:lights.term'), _dec9 = (0, _index.tooltip)('i18n:lights.size'), _dec10 = (0, _index.tooltip)('i18n:lights.range'), _dec(_class = _dec2(_class = _dec3(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = class SphereLight extends _lightComponent.Light {
  /**
  ...
  get luminousFlux() {
    ...
    if (isHDR) {
      return this._luminanceHDR * _index2.scene.nt2lm(this._size);
    } else {
  ...
  set luminousFlux(val) {
    ...
    if (isHDR) {
      this._luminanceHDR = val / _index2.scene.nt2lm(this._size);
  ...
  _createLight() {
    ...
    if (_globalExports.legacyCC.director.root.pipeline.pipelineSceneData.isHDR) {
      this._luminanceLDR = this._luminanceHDR * _index3.Camera.standardExposureValue * _index3.Camera.standardLightMeterScale;
    } else {
      this._luminanceHDR = this._luminanceLDR / _index3.Camera.standardExposureValue / _index3.Camera.standardLightMeterScale;
    }
