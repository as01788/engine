 ...
 * 刚体组件。
 */
let RigidBody = (_dec = (0, _index.ccclass)('cc.RigidBody'), _dec2 = (0, _index.help)('i18n:cc.RigidBody'), _dec3 = (0, _index.menu)('Physics/RigidBody'), _dec4 = (0, _index.executionOrder)(-1), _dec5 = (0, _index.type)(_physicsSystem.PhysicsSystem.PhysicsGroup), _dec6 = (0, _index.displayOrder)(-2), _dec7 = (0, _index.tooltip)('i18n:physics3d.rigidbody.group'), _dec8 = (0, _index.type)(_physicsEnum.ERigidBodyType), _dec9 = (0, _index.displayOrder)(-1), _dec10 = (0, _index.tooltip)('i18n:physics3d.rigidbody.type'), _dec11 = (0, _index.visible)(isDynamicBody), _dec12 = (0, _index.displayOrder)(0), _dec13 = (0, _index.tooltip)('i18n:physics3d.rigidbody.mass'), _dec14 = (0, _index.visible)(isDynamicBody), _dec15 = (0, _index.displayOrder)(0.5), _dec16 = (0, _index.tooltip)('i18n:physics3d.rigidbody.allowSleep'), _dec17 = (0, _index.visible)(isDynamicBody), _dec18 = (0, _index.displayOrder)(1), _dec19 = (0, _index.tooltip)('i18n:physics3d.rigidbody.linearDamping'), _dec20 = (0, _index.visible)(isDynamicBody), _dec21 = (0, _index.displayOrder)(2), _dec22 = (0, _index.tooltip)('i18n:physics3d.rigidbody.angularDamping'), _dec23 = (0, _index.visible)(isDynamicBody), _dec24 = (0, _index.displayOrder)(4), _dec25 = (0, _index.tooltip)('i18n:physics3d.rigidbody.useGravity'), _dec26 = (0, _index.visible)(isDynamicBody), _dec27 = (0, _index.displayOrder)(6), _dec28 = (0, _index.tooltip)('i18n:physics3d.rigidbody.linearFactor'), _dec29 = (0, _index.visible)(isDynamicBody), _dec30 = (0, _index.displayOrder)(7), _dec31 = (0, _index.tooltip)('i18n:physics3d.rigidbody.angularFactor'), _dec(_class = _dec2(_class = _dec3(_class = (0, _index.executeInEditMode)(_class = (0, _index.disallowMultiple)(_class = _dec4(_class = (_class2 = (_temp = _class3 = class RigidBody extends _index3.Component {
  constructor(...args) {
    super(...args);
    this._body = null;
  ...
  set mass(value) {
    if (_internal253Aconstants.DEBUG && value <= 0) (0, _index3.warn)('[Physics]: The mass should be greater than zero.');
  ...
  set linearDamping(value) {
    if (_internal253Aconstants.DEBUG && (value < 0 || value > 1)) (0, _index3.warn)('[Physics]: The damping should be between zero to one.');
  ...
  get _isInitialized() {
    ...
    if (r) {
      (0, _index3.error)('[Physics]: This component has not been call onLoad yet, please make sure the node has been added to the scene.');
    }
  ...
  onLoad() {
    if (!_physicsSelector.selector.runInEditor) return;
    this._body = (0, _physicsSelector.createRigidBody)();
