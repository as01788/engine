 ...
 * 圆柱体碰撞器。
 */
let CylinderCollider = (_dec = (0, _index.ccclass)('cc.CylinderCollider'), _dec2 = (0, _index.help)('i18n:cc.CylinderCollider'), _dec3 = (0, _index.menu)('Physics/CylinderCollider'), _dec4 = (0, _index.tooltip)('i18n:physics3d.collider.cylinder_radius'), _dec5 = (0, _index.tooltip)('i18n:physics3d.collider.cylinder_height'), _dec6 = (0, _index.type)(_physicsEnum.EAxisDirection), _dec7 = (0, _index.tooltip)('i18n:physics3d.collider.cylinder_direction'), _dec(_class = _dec2(_class = _dec3(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = class CylinderCollider extends _collider.Collider {
