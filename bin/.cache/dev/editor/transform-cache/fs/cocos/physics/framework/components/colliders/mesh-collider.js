 ...
 * 三角网格碰撞器。
 */
let MeshCollider = (_dec = (0, _index.ccclass)('cc.MeshCollider'), _dec2 = (0, _index.help)('i18n:cc.MeshCollider'), _dec3 = (0, _index.menu)('Physics/MeshCollider'), _dec4 = (0, _index.type)(_index2.Mesh), _dec5 = (0, _index.tooltip)('i18n:physics3d.collider.mesh_mesh'), _dec6 = (0, _index.tooltip)('i18n:physics3d.collider.mesh_convex'), _dec(_class = _dec2(_class = _dec3(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = class MeshCollider extends _collider.Collider {
...
}, _temp), (_applyDecoratedDescriptor(_class2.prototype, "mesh", [_dec4, _dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "mesh"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "convex", [_index.editable, _dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "convex"), _class2.prototype), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "_mesh", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
