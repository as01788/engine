  ...
  _updateMaterial(block, init) {
    ...
    if (this._currentMaterial == null || nLayers !== this._currentMaterialLayers) {
      ...
      if (this._brushMaterial !== null) {
        ...
        const brushMaterialInstance = new _material.Material();
...
class TerrainBlock {
  constructor(t, i, j) {
    ...
    this._lodLevel = 0;
    this._lodKey = new _terrainLod.TerrainLodKey();
    this._errorMetrics = [0, 0, 0, 0];
    this._LevelDistances = [_terrainLod.TERRAIN_LOD_MAX_DISTANCE, _terrainLod.TERRAIN_LOD_MAX_DISTANCE, _terrainLod.TERRAIN_LOD_MAX_DISTANCE, _terrainLod.TERRAIN_LOD_MAX_DISTANCE];
    this._bbMin = new _index6.Vec3();
    this._bbMax = new _index6.Vec3();
    this._terrain = t;
    this._index[0] = i;
    this._index[1] = j;
    this._lightmapInfo = t._getLightmapInfo(i, j);
    this._node = new _index8.Node('TerrainBlock');
  ...
  build() {
    ...
    for (let j = 0; j < _terrainAsset.TERRAIN_BLOCK_VERTEX_COMPLEXITY; ++j) {
      for (let i = 0; i < _terrainAsset.TERRAIN_BLOCK_VERTEX_COMPLEXITY; ++i) {
        ...
        _index6.Vec3.min(this._bbMin, this._bbMin, position);

        _index6.Vec3.max(this._bbMax, this._bbMax, position);
      }
    }
    ...
    this._renderable._model = _globalExports.legacyCC.director.root.createModel(_index7.scene.Model);
  ...
  _updateLevel(camPos) {
    const maxLevel = _terrainLod.TERRAIN_LOD_LEVELS - 1;
    const bbMin = new _index6.Vec3();
    const bbMax = new _index6.Vec3();

    _index6.Vec3.add(bbMin, this._bbMin, this._terrain.node.getWorldPosition());

    _index6.Vec3.add(bbMax, this._bbMax, this._terrain.node.getWorldPosition());

    const d1 = _index6.Vec3.distance(bbMin, camPos);

    const d2 = _index6.Vec3.distance(bbMax, camPos);
  ...
  _updateLod() {
    const key = new _terrainLod.TerrainLodKey();
  ...
  _getHeight(x, y, verts) {
    const idx = _terrainAsset.TERRAIN_BLOCK_VERTEX_COMPLEXITY * y + x;
    return verts[idx * _terrainAsset.TERRAIN_BLOCK_VERTEX_SIZE + 1];
  }
  ...
  _calcErrorMetrics(vertecs) {
    ...
    for (let i = 1; i < _terrainLod.TERRAIN_LOD_LEVELS; ++i) {
      this._errorMetrics[i] = this._calcErrorMetric(i, vertecs);
    }

    for (let i = 2; i < _terrainLod.TERRAIN_LOD_LEVELS; ++i) {
  ...
  _calcErrorMetric(level, vertecs) {
    let err = 0.0;
    const step = 1 << level;
    const xSectionVerts = _terrainAsset.TERRAIN_BLOCK_VERTEX_COMPLEXITY;
    const ySectionVerts = _terrainAsset.TERRAIN_BLOCK_VERTEX_COMPLEXITY;
...
let Terrain = (_dec4 = (0, _index.ccclass)('cc.Terrain'), _dec5 = (0, _index.help)('i18n:cc.Terrain'), _dec6 = (0, _index.type)(_terrainAsset.TerrainAsset), _dec7 = (0, _index.type)(_index3.EffectAsset), _dec8 = (0, _index.visible)(false), _dec9 = (0, _index.type)(TerrainBlockLightmapInfo), _dec10 = (0, _index.type)(_index8.CCBoolean), _dec11 = (0, _index.type)(_index8.CCBoolean), _dec12 = (0, _index.type)(_index8.CCBoolean), _dec13 = (0, _index.type)(_index8.CCBoolean), _dec14 = (0, _index.type)(_index8.CCFloat), _dec15 = (0, _index.type)(_terrainAsset.TerrainAsset), _dec16 = (0, _index.visible)(true), _dec17 = (0, _index.type)(_index3.EffectAsset), _dec18 = (0, _index.visible)(true), _dec19 = (0, _index.type)(TerrainInfo), _dec4(_class10 = _dec5(_class10 = (0, _index.executeInEditMode)(_class10 = (0, _index.disallowMultiple)(_class10 = (_class11 = (_temp4 = class Terrain extends _index4.Component {
  ...
  constructor() {
    ...
    _initializerDefineProperty(this, "_lodEnable", _descriptor21, this);

    _initializerDefineProperty(this, "_lodBias", _descriptor22, this);
    ...
    this._layerBuffer = [];
    this._blocks = [];
    this._lod = new _terrainLod.TerrainLod();
  ...
  set _asset(value) {
    ...
    if (this._buitinAsset !== this.__asset) {
      ...
      if (_globalExports.legacyCC.director.root.device) {
        // rebuild
        this._buildImp();
      }
    }
  ...
  onEnable() {
    ...
    _globalExports.legacyCC.director.root.pipeline.on(_index8.PipelineEventType.RENDER_CAMERA_BEGIN, this.onUpdateFromCamera, this);
  }

  onDisable() {
    _globalExports.legacyCC.director.root.pipeline.off(_index8.PipelineEventType.RENDER_CAMERA_BEGIN, this.onUpdateFromCamera, this);
  ...
  _getSharedIndexBuffer() {
    if (this._sharedIndexBuffer == null) {
      ...
      this._sharedIndexBuffer = gfxDevice.createBuffer(new _index5.BufferInfo(_index5.BufferUsageBit.INDEX | _index5.BufferUsageBit.TRANSFER_DST, _index5.MemoryUsageBit.DEVICE, Uint16Array.BYTES_PER_ELEMENT * this._lod._indexBuffer.length, Uint16Array.BYTES_PER_ELEMENT));
...
}), _descriptor21 = _applyDecoratedDescriptor(_class11.prototype, "_lodEnable", [_dec13, _index.serializable, _index.disallowAnimation], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor22 = _applyDecoratedDescriptor(_class11.prototype, "_lodBias", [_dec14, _index.serializable, _index.disallowAnimation], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _applyDecoratedDescriptor(_class11.prototype, "_asset", [_dec15, _dec16], Object.getOwnPropertyDescriptor(_class11.prototype, "_asset"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "effectAsset", [_dec17, _dec18], Object.getOwnPropertyDescriptor(_class11.prototype, "effectAsset"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "receiveShadow", [_index.editable], Object.getOwnPropertyDescriptor(_class11.prototype, "receiveShadow"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "useNormalMap", [_index.editable], Object.getOwnPropertyDescriptor(_class11.prototype, "useNormalMap"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "usePBR", [_index.editable], Object.getOwnPropertyDescriptor(_class11.prototype, "usePBR"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "lodEnable", [_index.editable], Object.getOwnPropertyDescriptor(_class11.prototype, "lodEnable"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "LodBias", [_index.editable], Object.getOwnPropertyDescriptor(_class11.prototype, "LodBias"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "info", [_dec19], Object.getOwnPropertyDescriptor(_class11.prototype, "info"), _class11.prototype)), _class11)) || _class10) || _class10) || _class10) || _class10);
