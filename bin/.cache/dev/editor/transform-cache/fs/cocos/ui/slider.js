...
const _tempPos = new _index4.Vec3();
/**
 * @en
...
let Slider = (_dec = (0, _index.ccclass)('cc.Slider'), _dec2 = (0, _index.help)('i18n:cc.Slider'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/Slider'), _dec5 = (0, _index.requireComponent)(_index3.UITransform), _dec6 = (0, _index.type)(_sprite.Sprite), _dec7 = (0, _index.tooltip)('i18n:slider.handle'), _dec8 = (0, _index.type)(Direction), _dec9 = (0, _index.tooltip)('i18n:slider.direction'), _dec10 = (0, _index.range)([0, 1, 0.01]), _dec11 = (0, _index.tooltip)('i18n:slider.progress'), _dec12 = (0, _index.type)([_index2.EventHandler]), _dec13 = (0, _index.tooltip)('i18n:slider.slideEvents'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = class Slider extends _index2.Component {
  constructor(...args) {
    ...
    this._offset = new _index4.Vec3();
    this._dragging = false;
    this._touchHandle = false;
    this._handleLocalPos = new _index4.Vec3();
    this._touchPos = new _index4.Vec3();
  }
  ...
  onEnable() {
    ...
    this.node.on(_nodeEvent.NodeEventType.TOUCH_MOVE, this._onTouchMoved, this);
    this.node.on(_nodeEvent.NodeEventType.TOUCH_END, this._onTouchEnded, this);
    this.node.on(_nodeEvent.NodeEventType.TOUCH_CANCEL, this._onTouchCancelled, this);

    if (this._handle && this._handle.isValid) {
      this._handle.node.on(_nodeEvent.NodeEventType.TOUCH_START, this._onHandleDragStart, this);

      this._handle.node.on(_nodeEvent.NodeEventType.TOUCH_MOVE, this._onTouchMoved, this);

      this._handle.node.on(_nodeEvent.NodeEventType.TOUCH_END, this._onTouchEnded, this);
    }
  }

  onDisable() {
    this.node.off(_nodeEvent.NodeEventType.TOUCH_START, this._onTouchBegan, this);
    this.node.off(_nodeEvent.NodeEventType.TOUCH_MOVE, this._onTouchMoved, this);
    this.node.off(_nodeEvent.NodeEventType.TOUCH_END, this._onTouchEnded, this);
    this.node.off(_nodeEvent.NodeEventType.TOUCH_CANCEL, this._onTouchCancelled, this);

    if (this._handle && this._handle.isValid) {
      this._handle.node.off(_nodeEvent.NodeEventType.TOUCH_START, this._onHandleDragStart, this);

      this._handle.node.off(_nodeEvent.NodeEventType.TOUCH_MOVE, this._onTouchMoved, this);

      this._handle.node.off(_nodeEvent.NodeEventType.TOUCH_END, this._onTouchEnded, this);
    }
  }
  ...
  _onHandleDragStart(event) {
    ...
    _index4.Vec3.set(this._touchPos, touhPos.x, touhPos.y, 0);
  ...
  _updateProgress(touch) {
    ...
    _index4.Vec3.set(this._touchPos, touchPos.x, touchPos.y, 0);
