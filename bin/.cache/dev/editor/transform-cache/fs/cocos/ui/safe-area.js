...
let SafeArea = (_dec = (0, _index.ccclass)('cc.SafeArea'), _dec2 = (0, _index.help)('i18n:cc.SafeArea'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/SafeArea'), _dec5 = (0, _index.requireComponent)(_widget.Widget), _dec(_class = _dec2(_class = _dec3(_class = (0, _index.executeInEditMode)(_class = _dec4(_class = _dec5(_class = class SafeArea extends _index2.Component {
  onEnable() {
    ...
    _screenAdapter.screenAdapter.on('window-resize', this.updateArea, this);

    _screenAdapter.screenAdapter.on('orientation-change', this.updateArea, this);
  }

  onDisable() {
    _screenAdapter.screenAdapter.off('window-resize', this.updateArea, this);

    _screenAdapter.screenAdapter.off('orientation-change', this.updateArea, this);
  }
  /**
  ...
  updateArea() {
    ...
    const visibleSize = _index4.view.getVisibleSize();
