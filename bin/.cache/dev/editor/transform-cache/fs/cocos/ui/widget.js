...
let Widget = (_dec = (0, _index.ccclass)('cc.Widget'), _dec2 = (0, _index.help)('i18n:cc.Widget'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/Widget'), _dec5 = (0, _index.requireComponent)(_uiTransform.UITransform), _dec6 = (0, _index.type)(_node.Node), _dec7 = (0, _index.tooltip)('i18n:widget.target'), _dec8 = (0, _index.tooltip)('i18n:widget.align_top'), _dec9 = (0, _index.tooltip)('i18n:widget.align_bottom'), _dec10 = (0, _index.tooltip)('i18n:widget.align_left'), _dec11 = (0, _index.tooltip)('i18n:widget.align_right'), _dec12 = (0, _index.tooltip)('i18n:widget.align_h_center'), _dec13 = (0, _index.tooltip)('i18n:widget.align_v_center'), _dec14 = (0, _index.visible)(false), _dec15 = (0, _index.visible)(false), _dec16 = (0, _index.tooltip)('i18n:widget.top'), _dec17 = (0, _index.tooltip)('i18n:widget.bottom'), _dec18 = (0, _index.tooltip)('i18n:widget.left'), _dec19 = (0, _index.tooltip)('i18n:widget.right'), _dec20 = (0, _index.tooltip)('i18n:widget.horizontal_center'), _dec21 = (0, _index.tooltip)('i18n:widget.vertical_center'), _dec22 = (0, _index.type)(AlignMode), _dec23 = (0, _index.tooltip)('i18n:widget.align_mode'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = _class3 = class Widget extends _index2.Component {
  ...
  _registerEvent() {
    if (_internal253Aconstants.EDITOR && !_globalExports.legacyCC.GAME_VIEW) {
      this.node.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._adjustWidgetToAllowMovingInEditor, this);
      this.node.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this._adjustWidgetToAllowResizingInEditor, this);
    } else {
      this.node.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._setDirtyByMode, this);
      this.node.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this._setDirtyByMode, this);
    }

    this.node.on(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._adjustWidgetToAnchorChanged, this);
    this.node.on(_nodeEvent.NodeEventType.PARENT_CHANGED, this._adjustTargetToParentChanged, this);
  }

  _unregisterEvent() {
    if (_internal253Aconstants.EDITOR && !_globalExports.legacyCC.GAME_VIEW) {
      this.node.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._adjustWidgetToAllowMovingInEditor, this);
      this.node.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this._adjustWidgetToAllowResizingInEditor, this);
    } else {
      this.node.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._setDirtyByMode, this);
      this.node.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this._setDirtyByMode, this);
    }

    this.node.off(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._adjustWidgetToAnchorChanged, this);
  }

  _removeParentEvent() {
    this.node.off(_nodeEvent.NodeEventType.PARENT_CHANGED, this._adjustTargetToParentChanged, this);
  }
  ...
  _registerTargetEvents() {
    ...
    if (target) {
      if (target.getComponent(_uiTransform.UITransform)) {
        target.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._setDirtyByMode, this);
        target.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this._setDirtyByMode, this);
        target.on(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._setDirtyByMode, this);
      }
    }
  }
  ...
  _unregisterTargetEvents() {
    ...
    if (target) {
      target.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._setDirtyByMode, this);
      target.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this._setDirtyByMode, this);
      target.off(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._setDirtyByMode, this);
    }
  }
  ...
  _setDirtyByMode() {
    if (this.alignMode === AlignMode.ALWAYS || _internal253Aconstants.EDITOR) {
      this._recursiveDirty();
    }
  }
