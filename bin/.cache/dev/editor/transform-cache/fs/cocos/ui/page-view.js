...
let PageView = (_dec = (0, _index.ccclass)('cc.PageView'), _dec2 = (0, _index.help)('i18n:cc.PageView'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/PageView'), _dec5 = (0, _index.type)(SizeMode), _dec6 = (0, _index.tooltip)('i18n:pageview.sizeMode'), _dec7 = (0, _index.type)(Direction), _dec8 = (0, _index.tooltip)('i18n:pageview.direction'), _dec9 = (0, _index.range)([0, 1, 0.01]), _dec10 = (0, _index.tooltip)('i18n:pageview.scrollThreshold'), _dec11 = (0, _index.range)([0, 1, 0.01]), _dec12 = (0, _index.tooltip)('i18n:pageview.pageTurningEventTiming'), _dec13 = (0, _index.type)(_pageViewIndicator.PageViewIndicator), _dec14 = (0, _index.tooltip)('i18n:pageview.indicator'), _dec15 = (0, _index.tooltip)('i18n:pageview.autoPageTurningThreshold'), _dec16 = (0, _index.type)(_scrollBar.ScrollBar), _dec17 = (0, _index.visible)(false), _dec18 = (0, _index.type)(_scrollBar.ScrollBar), _dec19 = (0, _index.visible)(false), _dec20 = (0, _index.visible)(false), _dec21 = (0, _index.visible)(false), _dec22 = (0, _index.visible)(false), _dec23 = (0, _index.type)([_index2.EventHandler]), _dec24 = (0, _index.visible)(false), _dec25 = (0, _index.tooltip)('i18n:pageview.pageTurningSpeed'), _dec26 = (0, _index.type)([_index2.EventHandler]), _dec27 = (0, _index.tooltip)('i18n:pageview.pageEvents'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = class PageView extends _scrollView.ScrollView {
  constructor(...args) {
    ...
    this._lastPageIdx = 0;
    this._pages = [];
    this._initContentPos = new _index3.Vec3();
    this._scrollCenterOffsetX = [];
    this._scrollCenterOffsetY = [];
    this._touchBeganPosition = new _index3.Vec2();
    this._touchEndPosition = new _index3.Vec2();
  }
  ...
  onEnable() {
    super.onEnable();
    this.node.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this._updateAllPagesSize, this);
  ...
  onDisable() {
    super.onDisable();
    this.node.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this._updateAllPagesSize, this);
  ...
  _onTouchBegan(event, captureListeners) {
    ...
    _index3.Vec2.set(this._touchBeganPosition, _tempVec2.x, _tempVec2.y);
  ...
  _onTouchEnded(event, captureListeners) {
    ...
    _index3.Vec2.set(this._touchEndPosition, _tempVec2.x, _tempVec2.y);
  ...
  _autoScrollToPage() {
    ...
    if (bounceBackStarted) {
      ...
      const moveOffset = new _index3.Vec2();

      _index3.Vec2.subtract(moveOffset, this._touchBeganPosition, this._touchEndPosition);
...
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "pageTurningSpeed", [_index.serializable, _index.editable, _dec25], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "pageEvents", [_dec26, _index.serializable, _dec27], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
