...
var _index3 = require("../input/types/index.js");
...
const _tempVec3 = new _index4.Vec3();

const _tempVec3_1 = new _index4.Vec3();

const _tempVec2 = new _index4.Vec2();

const _tempVec2_1 = new _index4.Vec2();
...
let ScrollView = (_dec = (0, _index.ccclass)('cc.ScrollView'), _dec2 = (0, _index.help)('i18n:cc.ScrollView'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/ScrollView'), _dec5 = (0, _index.requireComponent)(_index2.UITransform), _dec6 = (0, _index.range)([0, 10]), _dec7 = (0, _index.displayOrder)(0), _dec8 = (0, _index.tooltip)('i18n:scrollview.bounceDuration'), _dec9 = (0, _index.range)([0, 1, 0.1]), _dec10 = (0, _index.displayOrder)(1), _dec11 = (0, _index.tooltip)('i18n:scrollview.brake'), _dec12 = (0, _index.displayOrder)(2), _dec13 = (0, _index.tooltip)('i18n:scrollview.elastic'), _dec14 = (0, _index.displayOrder)(3), _dec15 = (0, _index.tooltip)('i18n:scrollview.inertia'), _dec16 = (0, _index.type)(_node.Node), _dec17 = (0, _index.displayOrder)(4), _dec18 = (0, _index.tooltip)('i18n:scrollview.content'), _dec19 = (0, _index.displayOrder)(5), _dec20 = (0, _index.tooltip)('i18n:scrollview.horizontal'), _dec21 = (0, _index.type)(_scrollBar.ScrollBar), _dec22 = (0, _index.displayOrder)(6), _dec23 = (0, _index.tooltip)('i18n:scrollview.horizontal_bar'), _dec24 = (0, _index.displayOrder)(7), _dec25 = (0, _index.tooltip)('i18n:scrollview.vertical'), _dec26 = (0, _index.type)(_scrollBar.ScrollBar), _dec27 = (0, _index.displayOrder)(8), _dec28 = (0, _index.tooltip)('i18n:scrollview.vertical_bar'), _dec29 = (0, _index.displayOrder)(9), _dec30 = (0, _index.tooltip)('i18n:scrollview.cancelInnerEvents'), _dec31 = (0, _index.type)([_componentEventHandler.EventHandler]), _dec32 = (0, _index.displayOrder)(10), _dec33 = (0, _index.tooltip)('i18n:scrollview.scrollEvents'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = class ScrollView extends _viewGroup.ViewGroup {
  constructor(...args) {
    ...
    this._autoScrollStartPosition = new _index4.Vec3();
    this._autoScrollTargetDelta = new _index4.Vec3();
    this._autoScrollTotalTime = 0;
    this._autoScrollAccumulatedTime = 0;
    this._autoScrollCurrentlyOutOfBoundary = false;
    this._autoScrollBraking = false;
    this._autoScrollBrakingStartPosition = new _index4.Vec3();
    this._outOfBoundaryAmount = new _index4.Vec3();
    ...
    this._contentPos = new _index4.Vec3();
    this._deltaPos = new _index4.Vec3();
  }
  ...
  set horizontalScrollBar(value) {
    ...
    if (this._horizontalScrollBar) {
      ...
      this._updateScrollBar(_index4.Vec2.ZERO);
    }
  }
  /**
   * @en
  ...
  scrollToOffset(offset, timeInSecond, attenuated = true) {
    ...
    const anchor = new _index4.Vec2(0, 0); // if maxScrollOffset is 0, then always align the content's top left origin to the top left corner of its parent
  ...
  getScrollOffset() {
    ...
    return new _index4.Vec2(leftDelta, topDelta);
  }
  /**
   * @en
  ...
  getMaxScrollOffset() {
    ...
    return new _index4.Vec2(horizontalMaximizeOffset, verticalMaximizeOffset);
  }
  /**
   * @en
  ...
  _getContentPosition() {
    if (!this._content) {
      return _index4.Vec3.ZERO.clone();
    }
  ...
  onEnable() {
    if (!_internal253Aconstants.EDITOR || _globalExports.legacyCC.GAME_VIEW) {
      ...
      if (this._content) {
        this._content.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this._calculateBoundary, this);

        this._content.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._scaleChanged, this);

        if (this.view) {
          this.view.node.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._scaleChanged, this);
          this.view.node.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this._calculateBoundary, this);
        }
      }
  ...
  onDisable() {
    if (!_internal253Aconstants.EDITOR || _globalExports.legacyCC.GAME_VIEW) {
      ...
      if (this._content) {
        this._content.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this._calculateBoundary, this);

        this._content.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._scaleChanged, this);

        if (this.view) {
          this.view.node.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._scaleChanged, this);
          this.view.node.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this._calculateBoundary, this);
        }
      }
    }
  ...
  _registerEvent() {
    this.node.on(_nodeEvent.NodeEventType.TOUCH_START, this._onTouchBegan, this, true);
    this.node.on(_nodeEvent.NodeEventType.TOUCH_MOVE, this._onTouchMoved, this, true);
    this.node.on(_nodeEvent.NodeEventType.TOUCH_END, this._onTouchEnded, this, true);
    this.node.on(_nodeEvent.NodeEventType.TOUCH_CANCEL, this._onTouchCancelled, this, true);
    this.node.on(_nodeEvent.NodeEventType.MOUSE_WHEEL, this._onMouseWheel, this, true);
  }

  _unregisterEvent() {
    this.node.off(_nodeEvent.NodeEventType.TOUCH_START, this._onTouchBegan, this, true);
    this.node.off(_nodeEvent.NodeEventType.TOUCH_MOVE, this._onTouchMoved, this, true);
    this.node.off(_nodeEvent.NodeEventType.TOUCH_END, this._onTouchEnded, this, true);
    this.node.off(_nodeEvent.NodeEventType.TOUCH_CANCEL, this._onTouchCancelled, this, true);
    this.node.off(_nodeEvent.NodeEventType.MOUSE_WHEEL, this._onMouseWheel, this, true);
  }
  ...
  _onMouseWheel(event, captureListeners) {
    ...
    const deltaMove = new _index4.Vec3();
  ...
  _onTouchMoved(event, captureListeners) {
    ...
    if (deltaMove.length() > 7) {
      if (!this._touchMoved && event.target !== this.node) {
        ...
        const cancelEvent = new _index3.EventTouch(event.getTouches(), event.bubbles, _index3.SystemEventType.TOUCH_CANCEL);
  ...
  _startInertiaScroll(touchMoveVelocity) {
    const inertiaTotalMovement = new _index4.Vec3(touchMoveVelocity);
  ...
  _startAutoScroll(deltaMove, timeInSecond, attenuated = false) {
    ...
    _index4.Vec3.copy(this._autoScrollStartPosition, this._getContentPosition());
    ...
    if (!currentOutOfBoundary.equals(_index4.Vec3.ZERO, EPSILON)) {
      this._autoScrollCurrentlyOutOfBoundary = true;
    }
  }

  _calculateTouchMoveVelocity() {
    const out = new _index4.Vec3();
    let totalTime = 0;
    totalTime = this._touchMoveTimeDeltas.reduce((a, b) => a + b, totalTime);

    if (totalTime <= 0 || totalTime >= 0.5) {
      out.set(_index4.Vec3.ZERO);
    } else {
      let totalMovement = new _index4.Vec3();
  ...
  _getHowMuchOutOfBoundary(addition) {
    ...
    if (addition.equals(_index4.Vec3.ZERO, EPSILON) && !this._outOfBoundaryAmountDirty) {
      return this._outOfBoundaryAmount;
    }

    const outOfBoundaryAmount = new _index4.Vec3();
    ...
    if (addition.equals(_index4.Vec3.ZERO, EPSILON)) {
  ...
  _scrollChildren(deltaMove) {
    ...
    if (this._content) {
      ...
      const pos = this._content.position || _index4.Vec3.ZERO;
  ...
  _startBounceBackIfNeeded() {
    ...
    if (bounceBackAmount.equals(_index4.Vec3.ZERO, EPSILON)) {
      return false;
    }
  ...
  _isOutOfBoundary() {
    ...
    return !outOfBoundary.equals(_index4.Vec3.ZERO, EPSILON);
  }
  ...
  _processAutoScrolling(dt) {
    ...
    if (this.elastic) {
      ...
      if (!outOfBoundary.equals(_index4.Vec3.ZERO, EPSILON)) {
  ...
  _calculateMovePercentDelta(options) {
    ...
    anchor.clampf(_index4.Vec2.ZERO, _index4.Vec2.ONE);
    ...
    leftDelta = -leftDelta;
    const moveDelta = new _index4.Vec3();
