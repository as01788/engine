...
const _tempColor = new _index5.Color();
/**
...
let Button = (_dec = (0, _index.ccclass)('cc.Button'), _dec2 = (0, _index.help)('i18n:cc.Button'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/Button'), _dec5 = (0, _index.requireComponent)(_index4.UITransform), _dec6 = (0, _index.type)(_node.Node), _dec7 = (0, _index.displayOrder)(0), _dec8 = (0, _index.tooltip)('i18n:button.target'), _dec9 = (0, _index.displayOrder)(1), _dec10 = (0, _index.tooltip)('i18n:button.interactable'), _dec11 = (0, _index.type)(Transition), _dec12 = (0, _index.displayOrder)(2), _dec13 = (0, _index.tooltip)('i18n:button.transition'), _dec14 = (0, _index.tooltip)('i18n:button.normal_color'), _dec15 = (0, _index.tooltip)('i18n:button.pressed_color'), _dec16 = (0, _index.tooltip)('i18n:button.hover_color'), _dec17 = (0, _index.tooltip)('i18n:button.disabled_color'), _dec18 = (0, _index.rangeMin)(0), _dec19 = (0, _index.rangeMax)(10), _dec20 = (0, _index.tooltip)('i18n:button.duration'), _dec21 = (0, _index.tooltip)('i18n:button.zoom_scale'), _dec22 = (0, _index.type)(_index2.SpriteFrame), _dec23 = (0, _index.tooltip)('i18n:button.normal_sprite'), _dec24 = (0, _index.type)(_index2.SpriteFrame), _dec25 = (0, _index.tooltip)('i18n:button.pressed_sprite'), _dec26 = (0, _index.type)(_index2.SpriteFrame), _dec27 = (0, _index.tooltip)('i18n:button.hover_sprite'), _dec28 = (0, _index.type)(_index2.SpriteFrame), _dec29 = (0, _index.tooltip)('i18n:button.disabled_sprite'), _dec30 = (0, _index.type)([_index3.EventHandler]), _dec31 = (0, _index.displayOrder)(20), _dec32 = (0, _index.tooltip)('i18n:button.click_events'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = _class3 = class Button extends _index3.Component {
  constructor(...args) {
    ...
    this._pressed = false;
    this._hovered = false;
    this._fromColor = new _index5.Color();
    this._toColor = new _index5.Color();
    this._time = 0;
    this._transitionFinished = true;
    this._fromScale = new _index5.Vec3();
    this._toScale = new _index5.Vec3();
    this._originalScale = null;
    this._sprite = null;
    this._targetScale = new _index5.Vec3();
  }
  ...
  update(dt) {
    ...
    if (this._transition === Transition.COLOR) {
      ...
      _index5.Color.lerp(_tempColor, this._fromColor, this._toColor, ratio);
  ...
  _registerNodeEvent() {
    this.node.on(_nodeEvent.NodeEventType.TOUCH_START, this._onTouchBegan, this);
    this.node.on(_nodeEvent.NodeEventType.TOUCH_MOVE, this._onTouchMove, this);
    this.node.on(_nodeEvent.NodeEventType.TOUCH_END, this._onTouchEnded, this);
    this.node.on(_nodeEvent.NodeEventType.TOUCH_CANCEL, this._onTouchCancel, this);
    this.node.on(_nodeEvent.NodeEventType.MOUSE_ENTER, this._onMouseMoveIn, this);
    this.node.on(_nodeEvent.NodeEventType.MOUSE_LEAVE, this._onMouseMoveOut, this);
  }

  _registerTargetEvent(target) {
    if (_internal253Aconstants.EDITOR && !_globalExports.legacyCC.GAME_VIEW) {
      target.on(_sprite.Sprite.EventType.SPRITE_FRAME_CHANGED, this._onTargetSpriteFrameChanged, this);
      target.on(_nodeEvent.NodeEventType.COLOR_CHANGED, this._onTargetColorChanged, this);
    }

    target.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._onTargetTransformChanged, this);
  }

  _unregisterNodeEvent() {
    this.node.off(_nodeEvent.NodeEventType.TOUCH_START, this._onTouchBegan, this);
    this.node.off(_nodeEvent.NodeEventType.TOUCH_MOVE, this._onTouchMove, this);
    this.node.off(_nodeEvent.NodeEventType.TOUCH_END, this._onTouchEnded, this);
    this.node.off(_nodeEvent.NodeEventType.TOUCH_CANCEL, this._onTouchCancel, this);
    this.node.off(_nodeEvent.NodeEventType.MOUSE_ENTER, this._onMouseMoveIn, this);
    this.node.off(_nodeEvent.NodeEventType.MOUSE_LEAVE, this._onMouseMoveOut, this);
  }

  _unregisterTargetEvent(target) {
    if (_internal253Aconstants.EDITOR && !_globalExports.legacyCC.GAME_VIEW) {
      target.off(_sprite.Sprite.EventType.SPRITE_FRAME_CHANGED);
      target.off(_nodeEvent.NodeEventType.COLOR_CHANGED);
    }

    target.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED);
  }
  ...
  _applyTarget() {
    if (this.target) {
      ...
      if (!this._originalScale) {
        this._originalScale = new _index5.Vec3();
      }

      _index5.Vec3.copy(this._originalScale, this.target.getScale());
  ...
  _onTouchMove(event) {
    ...
    if (this._transition === Transition.SCALE && this.target && this._originalScale) {
      if (hit) {
        _index5.Vec3.copy(this._fromScale, this._originalScale);

        _index5.Vec3.multiplyScalar(this._toScale, this._originalScale, this._zoomScale);
  ...
  _zoomBack() {
    ...
    _index5.Vec3.copy(this._fromScale, this.target.getScale());

    _index5.Vec3.copy(this._toScale, this._originalScale);
  ...
  writable: true,
  initializer: function () {
    return _index5.Color.WHITE.clone();
  }
  ...
  writable: true,
  initializer: function () {
    return new _index5.Color(211, 211, 211, 255);
  }
  ...
  writable: true,
  initializer: function () {
    return new _index5.Color(124, 124, 124, 255);
  }
