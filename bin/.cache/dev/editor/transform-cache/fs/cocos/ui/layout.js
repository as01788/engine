...
let Layout = (_dec = (0, _index.ccclass)('cc.Layout'), _dec2 = (0, _index.help)('i18n:cc.Layout'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/Layout'), _dec5 = (0, _index.requireComponent)(_uiTransform.UITransform), _dec6 = (0, _index.visible)(function () {
  ...
  _addEventListeners() {
    ...
    this.node.on(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._doLayoutDirty, this);
    this.node.on(_nodeEvent.NodeEventType.CHILD_ADDED, this._childAdded, this);
    this.node.on(_nodeEvent.NodeEventType.CHILD_REMOVED, this._childRemoved, this);
    this.node.on(_nodeEvent.NodeEventType.SIBLING_ORDER_CHANGED, this._childrenChanged, this);
  ...
  _removeEventListeners() {
    ...
    this.node.off(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._doLayoutDirty, this);
    this.node.off(_nodeEvent.NodeEventType.CHILD_ADDED, this._childAdded, this);
    this.node.off(_nodeEvent.NodeEventType.CHILD_REMOVED, this._childRemoved, this);
    this.node.off(_nodeEvent.NodeEventType.SIBLING_ORDER_CHANGED, this._childrenChanged, this);
  ...
  _addChildrenEventListeners() {
    ...
    for (let i = 0; i < children.length; ++i) {
      const child = children[i];
      child.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this._doLayoutDirty, this);
      child.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._transformDirty, this);
      child.on(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._doLayoutDirty, this);
      child.on(_nodeEvent.NodeEventType.ACTIVE_IN_HIERARCHY_CHANGED, this._childrenChanged, this);
    }
  }
  ...
  _removeChildrenEventListeners() {
    ...
    for (let i = 0; i < children.length; ++i) {
      const child = children[i];
      child.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this._doLayoutDirty, this);
      child.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._transformDirty, this);
      child.off(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._doLayoutDirty, this);
      child.off(_nodeEvent.NodeEventType.ACTIVE_IN_HIERARCHY_CHANGED, this._childrenChanged, this);
    }
  }
