...
class b2MouseJoint extends _joint2d.b2Joint {
  ...
  initialize(comp) {
    ...
    if (canvas) {
      canvas.on(_nodeEvent.NodeEventType.TOUCH_START, this.onTouchBegan, this);
      canvas.on(_nodeEvent.NodeEventType.TOUCH_MOVE, this.onTouchMove, this);
      canvas.on(_nodeEvent.NodeEventType.TOUCH_END, this.onTouchEnd, this);
      canvas.on(_nodeEvent.NodeEventType.TOUCH_CANCEL, this.onTouchEnd, this);
    }
  }
