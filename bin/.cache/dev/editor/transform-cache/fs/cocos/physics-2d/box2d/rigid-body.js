...
class b2RigidBody2D {
  ...
  _registerNodeEvents() {
    ...
    node.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._onNodeTransformChanged, this);
  }

  _unregisterNodeEvents() {
    const node = this.rigidBody.node;
    node.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._onNodeTransformChanged, this);
  }
