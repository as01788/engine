...
var _index2 = require("../../input/types/index.js");
...
(0, _xDeprecated.removeProperty)(_sceneGlobals.SceneGlobals.prototype, 'SceneGlobals.prototype', [{
  name: 'aspect'
}, {
  name: 'selfShadow'
}, {
...
(0, _xDeprecated.replaceProperty)(_index2.SystemEventType, 'SystemEventType', ['MOUSE_ENTER', 'MOUSE_LEAVE', 'TRANSFORM_CHANGED', 'SCENE_CHANGED_FOR_PERSISTS', 'SIZE_CHANGED', 'ANCHOR_CHANGED', 'COLOR_CHANGED', 'CHILD_ADDED', 'CHILD_REMOVED', 'PARENT_CHANGED', 'NODE_DESTROYED', 'LAYER_CHANGED', 'SIBLING_ORDER_CHANGED'].map(name => ({
  name,
  target: _node.Node.EventType,
  targetName: 'Node.EventType'
})));
(0, _xDeprecated.replaceProperty)(_node.Node.EventType, 'Node.EventType', [{
  name: 'DEVICEMOTION',
  target: _index3.SystemEvent.EventType,
