...
const effects = [{
  ...
  "shaders": [{
    ...
    "builtins": {
      "statistics": {
        "CC_EFFECT_USED_VERTEX_UNIFORM_VECTORS": 221,
        "CC_EFFECT_USED_FRAGMENT_UNIFORM_VECTORS": 64
      },
      "globals": {
        "blocks": [{
          "name": "CCGlobal",
    ...
    "builtins": {
      "statistics": {
        "CC_EFFECT_USED_VERTEX_UNIFORM_VECTORS": 182,
        "CC_EFFECT_USED_FRAGMENT_UNIFORM_VECTORS": 64
      },
      "globals": {
        "blocks": [{
  ...
  "shaders": [{
    ...
    "builtins": {
      "statistics": {
        "CC_EFFECT_USED_VERTEX_UNIFORM_VECTORS": 215,
        "CC_EFFECT_USED_FRAGMENT_UNIFORM_VECTORS": 58
      },
      "globals": {
        "blocks": [{
