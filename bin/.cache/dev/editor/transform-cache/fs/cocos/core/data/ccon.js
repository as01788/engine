...
exports.encodeCCONJson = encodeCCONJson;
exports.parseCCONJson = parseCCONJson;
exports.encodeCCONBinary = encodeCCONBinary;
exports.decodeCCONBinary = decodeCCONBinary;
exports.BufferBuilder = exports.InvalidCCONError = exports.CCON = void 0;
...
function decodeCCONBinary(bytes) {
  if (bytes.length < 16) {
    throw new InvalidCCONError((0, _debug.getError)(13102));
  }
  ...
  if (magic !== MAGIC) {
    throw new InvalidCCONError((0, _debug.getError)(13100));
  }

  const version = dataView.getUint32(4, true);

  if (version !== VERSION) {
    throw new InvalidCCONError((0, _debug.getError)(13101, version));
  }
...
function encodeJson(input) {
  if (typeof TextEncoder !== 'undefined') {
    ...
    throw new Error((0, _debug.getError)(13103));
  }
}
...
function decodeJson(data) {
  if (typeof TextDecoder !== 'undefined') {
    ...
    const {
      Buffer
    } = globalThis; // eslint-disable-next-line no-buffer-constructor

    return Buffer.from(data.buffer, data.byteOffset, data.byteLength).toString();
  } else {
    throw new Error((0, _debug.getError)(13104));
  }
}

class InvalidCCONError extends Error {}

exports.InvalidCCONError = InvalidCCONError;
...
_predefine.default.internal.parseCCONJson = parseCCONJson;
_predefine.default.internal.decodeCCONBinary = decodeCCONBinary;
_predefine.default.internal.CCON = CCON;