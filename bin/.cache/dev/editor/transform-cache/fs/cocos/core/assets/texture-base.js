...
let TextureBase = (_dec = (0, _index.ccclass)('cc.TextureBase'), _dec(_class = (_class2 = (_temp = _class3 = class TextureBase extends _asset.Asset {
  ...
  constructor() {
    ...
    this._height = 1;
    this._id = void 0;
    this._samplerInfo = new _index2.SamplerInfo();
  ...
  destroy() {
    ...
    if (destroyed && ((_legacyCC$director$ro = _globalExports.legacyCC.director.root) === null || _legacyCC$director$ro === void 0 ? void 0 : _legacyCC$director$ro.batcher2D)) {
