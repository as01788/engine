...
exports.__getDemoGraphs = __getDemoGraphs;

var _graphFromDescription = require("./graph-from-description.js");

function __getDemoGraphs() {
  return Object.entries(graphDescMap).reduce((result, [name, graphDesc]) => {
    result[name] = (0, _graphFromDescription.createGraphFromDescription)(graphDesc);
    return result;
  }, {});
}
