...
let TextureCube = (_dec = (0, _index.ccclass)('cc.TextureCube'), _dec(_class = (_class2 = (_temp = _class3 = class TextureCube extends _simpleTexture.SimpleTexture {
  constructor(...args) {
    ...
    _initializerDefineProperty(this, "_mipmaps", _descriptor2, this);
  }
...
}, _class3.FaceIndex = FaceIndex, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "isRGBE", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "_mipmaps", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
