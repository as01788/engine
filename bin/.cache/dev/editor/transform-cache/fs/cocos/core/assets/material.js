...
let Material = (_dec = (0, _index.ccclass)('cc.Material'), _dec2 = (0, _index.type)(_effectAsset.EffectAsset), _dec(_class = (_class2 = (_temp = class Material extends _asset.Asset {
  ...
  _uploadProperty(pass, name, val) {
    ...
    const type = _pass.Pass.getTypeFromHandle(handle);

    if (type < _index2.Type.SAMPLER1D) {
      if (Array.isArray(val)) {
        ...
        if ((_pass$properties$name = pass.properties[name]) === null || _pass$properties$name === void 0 ? void 0 : _pass$properties$name.linear) {
          const v4 = val;
          (0, _pipelineFuncs.SRGBToLinear)(v4_1, v4);
          v4_1.w = v4.w;
          val = v4_1;
        }
  ...
  _bindTexture(pass, handle, val, index) {
    ...
    } else if (val instanceof _textureBase.TextureBase) {
