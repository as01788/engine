...
_globalExports.legacyCC._MissingScript = MissingScript; // DEBUG: Check MissingScript class for issue 9878
...
try {
  ...
  if (props.length === 0 || props[props.length - 1] !== '_$erialized') {
    (0, _debug.error)(`The '_$erialized' prop in MissingScript is missing. Please contact jare.`);
    (0, _debug.error)(`    Error props: ['${props}']`); // props.push('_$erialized');
  }
} catch (e) {
  (0, _debug.error)(`Error when checking MissingScript 5, ${e}`);
}