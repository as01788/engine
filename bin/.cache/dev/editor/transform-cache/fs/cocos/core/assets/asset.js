...
var _gcObject = require("../data/gc-object.js");
 ...
 * @extends CCObject
 */
let Asset = (_dec = (0, _index.ccclass)('cc.Asset'), _dec(_class = (_class2 = (_temp = class Asset extends (0, _index2.Eventify)(_gcObject.GCObject) {
  /**
   * 应 AssetDB 要求提供这个方法。
   * @method deserialize
   * @param {String} data
  ...
  destroy() {
    (0, _debug.debug)((0, _debug.getError)(12101, this._uuid));
