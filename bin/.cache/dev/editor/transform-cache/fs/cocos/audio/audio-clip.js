...
var _playerWeb = require("../../pal/audio/web/player-web.js");
...
let AudioClip = (_dec = (0, _index.ccclass)('cc.AudioClip'), _dec(_class = (_class2 = (_temp = _class3 = class AudioClip extends _asset.Asset {
  ...
  playOneShot(volume = 1) {
    if (this._nativeAsset) {
      _audio.AudioPlayer.loadOneShotAudio(this._nativeAsset.url, volume).then(oneShotAudio => {
        oneShotAudio.play();
      }).catch(e => {});
    }
  ...
  loadAudioPlayerWeb(audioBuffer, url) {
    return new _playerWeb.AudioPlayerWeb(audioBuffer, url);
  }
