...
let TiledLayer = (_dec2 = (0, _index.ccclass)('cc.TiledLayer'), _dec2(_class3 = (_temp2 = class TiledLayer extends _renderable2d.Renderable2D {
  ...
  addUserNode(node) {
    ...
    node.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._userNodePosChange, dataComp);
    node.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this._userNodeSizeChange, dataComp);
    return true;
  }
  /**
  ...
  removeUserNode(node) {
    ...
    node.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this._userNodePosChange, dataComp);
    node.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this._userNodeSizeChange, dataComp);
  ...
  onEnable() {
    super.onEnable();
    this.node.on(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._syncAnchorPoint, this);
    this.node.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this.updateCulling, this);
    this.node.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this.updateCulling, this);
    this.node.parent.on(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this.updateCulling, this);
    this.node.parent.on(_nodeEvent.NodeEventType.SIZE_CHANGED, this.updateCulling, this);
  ...
  onDisable() {
    super.onDisable();
    this.node.parent.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this.updateCulling, this);
    this.node.parent.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this.updateCulling, this);
    this.node.off(_nodeEvent.NodeEventType.SIZE_CHANGED, this.updateCulling, this);
    this.node.off(_nodeEvent.NodeEventType.TRANSFORM_CHANGED, this.updateCulling, this);
    this.node.off(_nodeEvent.NodeEventType.ANCHOR_CHANGED, this._syncAnchorPoint, this);
  }
