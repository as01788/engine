System.register("q-bundled:///fs/editor/exports/offline-mappings.js", ["../../cocos/core/gfx/base/define.js", "../../cocos/core/pipeline/define.js", "../../cocos/core/utils/murmurhash2_gc.js", "../../cocos/core/gfx/base/states/sampler.js"], function (_export, _context) {
  "use strict";

  var Address, BlendFactor, BlendOp, ColorMask, ComparisonFunc, CullMode, DynamicStateFlagBit, Filter, Format, FormatInfos, FormatType, GetTypeSize, PolygonMode, PrimitiveMode, ShadeModel, ShaderStageFlagBit, StencilOp, Type, DescriptorType, SamplerInfo, MemoryAccessBit, RenderPassStage, RenderPriority, SetIndex, murmurhash2_32_gc, Sampler, typeMap, isSampler, isPaddedMatrix, formatMap, getFormat, getShaderStage, getDescriptorType, isNormalized, getMemoryAccessFlag, passParams, effectStructure;
  return {
    setters: [function (_cocosCoreGfxBaseDefineJs) {
      Address = _cocosCoreGfxBaseDefineJs.Address;
      BlendFactor = _cocosCoreGfxBaseDefineJs.BlendFactor;
      BlendOp = _cocosCoreGfxBaseDefineJs.BlendOp;
      ColorMask = _cocosCoreGfxBaseDefineJs.ColorMask;
      ComparisonFunc = _cocosCoreGfxBaseDefineJs.ComparisonFunc;
      CullMode = _cocosCoreGfxBaseDefineJs.CullMode;
      DynamicStateFlagBit = _cocosCoreGfxBaseDefineJs.DynamicStateFlagBit;
      Filter = _cocosCoreGfxBaseDefineJs.Filter;
      Format = _cocosCoreGfxBaseDefineJs.Format;
      FormatInfos = _cocosCoreGfxBaseDefineJs.FormatInfos;
      FormatType = _cocosCoreGfxBaseDefineJs.FormatType;
      GetTypeSize = _cocosCoreGfxBaseDefineJs.GetTypeSize;
      PolygonMode = _cocosCoreGfxBaseDefineJs.PolygonMode;
      PrimitiveMode = _cocosCoreGfxBaseDefineJs.PrimitiveMode;
      ShadeModel = _cocosCoreGfxBaseDefineJs.ShadeModel;
      ShaderStageFlagBit = _cocosCoreGfxBaseDefineJs.ShaderStageFlagBit;
      StencilOp = _cocosCoreGfxBaseDefineJs.StencilOp;
      Type = _cocosCoreGfxBaseDefineJs.Type;
      DescriptorType = _cocosCoreGfxBaseDefineJs.DescriptorType;
      SamplerInfo = _cocosCoreGfxBaseDefineJs.SamplerInfo;
      MemoryAccessBit = _cocosCoreGfxBaseDefineJs.MemoryAccessBit;
    ...
    }, function (_cocosCoreGfxBaseStatesSamplerJs) {
      Sampler = _cocosCoreGfxBaseStatesSamplerJs.Sampler;
    }],
    execute: function () {
      ...
      typeMap[typeMap.subpassInput = Type.SUBPASS_INPUT] = 'subpassInput'; // variations
