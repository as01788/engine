System.register("q-bundled:///fs/cocos/physics/bullet/bullet-shared-body.js", ["../../core/scene-graph/node-enum.js", "./bullet-utils.js", "./bullet-enum.js", "./bullet-cache.js", "../framework/index.js", "../framework/physics-enum.js", "../../core/utils/array.js", "./instantiated.js"], function (_export, _context) {
  "use strict";

  var TransformBit, bullet2CocosVec3, cocos2BulletQuat, cocos2BulletVec3, bullet2CocosQuat, btCollisionFlags, btCollisionObjectStates, EBtSharedBodyDirty, CC_V3_0, CC_QUAT_0, BulletCache, PhysicsSystem, ERigidBodyType, PhysicsGroup, fastRemoveAt, bt, v3_0, quat_0, IDCounter, BulletSharedBody;
  ...
  return {
    setters: [function (_coreSceneGraphNodeEnumJs) {
    ...
    execute: function () {
      ...
      _export("BulletSharedBody", BulletSharedBody = /*#__PURE__*/function () {
        ...
        _proto.syncPhysicsToGraphics = function syncPhysicsToGraphics() {
          ...
          this.node.worldPosition = bullet2CocosVec3(v3_0, bt.Transform_getOrigin(bt_transform)); // sync node to ghost
