System.register("q-bundled:///fs/cocos/2d/framework/ui-transform.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../core/components/index.js", "../../core/math/index.js", "../../core/geometry/index.js", "../../core/director.js", "../../core/platform/debug.js", "../../core/scene-graph/node-enum.js", "../../core/scene-graph/node-event.js", "../../core/platform/visible-rect.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, executeInEditMode, executionOrder, menu, tooltip, displayOrder, serializable, disallowMultiple, EDITOR, UI_GPU_DRIVEN, Component, Mat4, Rect, Size, Vec2, Vec3, AABB, Director, director, warnID, TransformBit, NodeEventType, visibleRect, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _class3, _temp, _vec2a, _vec2b, _vec3a, _mat4_temp, _matrix, _worldMatrix, _zeroMatrix, _rect, UITransform;
    ...
    execute: function () {
      ...
      _export("UITransform", UITransform = (_dec = ccclass('cc.UITransform'), _dec2 = help('i18n:cc.UITransform'), _dec3 = executionOrder(110), _dec4 = menu('UI/UITransform'), _dec5 = displayOrder(0), _dec6 = tooltip('i18n:ui_transform.content_size'), _dec7 = displayOrder(1), _dec8 = tooltip('i18n:ui_transform.anchor_point'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = disallowMultiple(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
        ...
        function UITransform() {
          ...
          if (UI_GPU_DRIVEN) {
            _this._rectDirty = true;
            _this._rectWithScale = new Vec3();
            _this._anchorCache = new Vec3();
          }
        ...
        _proto.isHit = function isHit(point) {
          var _this$node;
          ...
          var cameraPt = _vec2a;
          var testPt = _vec2b;
          var nodeEventProcessor = (_this$node = this.node) === null || _this$node === void 0 ? void 0 : _this$node.eventProcessor;
          ...
          for (var i = 0; i < cameras.length; i++) {
            ...
            if (testPt.x >= 0 && testPt.y >= 0 && testPt.x <= w && testPt.y <= h) {
              ...
              if (nodeEventProcessor && nodeEventProcessor.maskList) {
                var maskList = nodeEventProcessor.maskList;
                var parent = this.node;
                var length = maskList ? maskList.length : 0; // find mask parent, should hit test it
        ...
        _proto._markRenderDataDirty = function _markRenderDataDirty() {
          ...
          if (uiComp) {
            uiComp.markForUpdateRenderData(); // @ts-expect-error hack for canRender is false // HACK,Need remove
        ...
        _proto.checkAndUpdateRect = function checkAndUpdateRect(rot, scale) {
          if (this._rectDirty) {
            this._rectWithScale.x = scale.x * this.width;
            this._rectWithScale.y = scale.y * this.height;
            this._rectWithScale.z = scale.z;
            var lenX = (0.5 - this.anchorPoint.x) * this.width * scale.x;
            var lenY = (0.5 - this.anchorPoint.y) * this.height * scale.y;
            Vec3.transformQuat(this._anchorCache, _vec3a.set(lenX, lenY, 0), rot);
          }
        };

        _proto.setRectDirty = function setRectDirty(transformBit) {
