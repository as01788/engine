System.register("q-bundled:///fs/cocos/2d/components/ui-opacity.js", ["../../core/data/decorators/index.js", "../../core/components/component.js", "../../core/utils/misc.js"], function (_export, _context) {
  ...
  var ccclass, help, executeInEditMode, executionOrder, menu, tooltip, editable, serializable, Component, clampf, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _temp, UIOpacity;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("UIOpacity", UIOpacity = (_dec = ccclass('cc.UIOpacity'), _dec2 = help('i18n:cc.UIOpacity'), _dec3 = executionOrder(110), _dec4 = menu('UI/UIOpacity'), _dec5 = tooltip('i18n:UIOpacity.opacity'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        return UIOpacity;
      }(Component), _temp), (_applyDecoratedDescriptor(_class2.prototype, "opacity", [editable, _dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "opacity"), _class2.prototype), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "_opacity", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
