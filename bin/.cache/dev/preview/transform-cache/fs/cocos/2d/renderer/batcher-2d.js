System.register("q-bundled:///fs/cocos/2d/renderer/batcher-2d.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/assets/material.js", "../../core/gfx/index.js", "../../core/memop/index.js", "../../core/memop/cached-array.js", "./mesh-buffer.js", "./stencil-manager.js", "./draw-batch.js", "./vertex-format.js", "../../core/global-exports.js", "../../core/pipeline/define.js", "../../core/platform/sys.js", "../../core/math/index.js"], function (_export, _context) {
  "use strict";

  var JSB, Material, DescriptorSetInfo, BufferInfo, BufferUsageBit, MemoryUsageBit, Pool, RecyclePool, CachedArray, MeshBuffer, Stage, StencilManager, DrawBatch2D, VertexFormat, legacyCC, ModelLocalBindings, UBOLocal, sys, Mat4, _dsInfo, m4_1, Batcher2D, LocalDescriptorSet, DescriptorSetCache;
    ...
    execute: function () {
      ...
      _export("Batcher2D", Batcher2D = /*#__PURE__*/function () {
        ...
        _proto.commitComp = function commitComp(comp, frame, assembler, transform) {
          ...
          if (this._currHash !== dataHash || dataHash === 0 || this._currMaterial !== mat || this._currDepthStencilStateStage !== depthStencilStateStage) {
            ...
            if (renderData) {
              ...
              var _frame = renderData.frame;

              if (_frame) {
                this._currTexture = _frame.getGFXTexture();
                this._currSampler = _frame.getGFXSampler();
        ...
        _proto._preProcess = function _preProcess(node) {
          ...
          if (node._uiProps.opacityDirty) {
            ...
            if ((_node$parent = node.parent) === null || _node$parent === void 0 ? void 0 : _node$parent._uiProps) {
              ...
              if (_render && _render.markColorDirty) {
        ...
        _proto._requireBufferBatch = function _requireBufferBatch(attributes, vertexCount, indexCount) {
          ...
          var meshBufferUseCount = this._meshBufferUseCount.get(strideBytes) || 0; // @ts-expect-error Property '__isWebIOS14OrIPadOS14Env' does not exist on 'sys'
