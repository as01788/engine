System.register("q-bundled:///fs/cocos/2d/renderer/render-data.js", ["../../core/math/index.js", "../../core/memop/index.js", "../../core/utils/murmurhash2_gc.js"], function (_export, _context) {
  "use strict";

  var Color, Pool, RecyclePool, murmurhash2_32_gc, BaseRenderData, RenderData, MeshRenderData, QuadRenderData, _dataPool, _pool, _meshDataPool;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RenderData", RenderData = /*#__PURE__*/function (_BaseRenderData) {
        ...
        _proto.updateNode = function updateNode(comp) {
        ...
        _proto.updatePass = function updatePass(comp) {
        ...
        _proto.updateTexture = function updateTexture(frame) {
          this.frame = frame;
        ...
        _proto.updateHash = function updateHash() {
          var hashString = " " + this.layer + " " + this.blendHash + " " + this.textureHash;
          this.dataHash = murmurhash2_32_gc(hashString, 666);
          this.hashDirty = false;
        };

        _proto.updateRenderData = function updateRenderData(comp, frame) {
          if (this.passDirty) {
            this.material = comp.getRenderMaterial(0);
            this.blendHash = comp.blendHash;
            this.passDirty = false;
