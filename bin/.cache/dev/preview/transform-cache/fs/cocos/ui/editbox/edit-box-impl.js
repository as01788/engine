System.register("q-bundled:///fs/cocos/ui/editbox/edit-box-impl.js", ["pal/screen-adapter", "../../2d/assets/index.js", "../../core/director.js", "../../core/game.js", "../../core/math/index.js", "../../core/platform/index.js", "../../input/types/index.js", "../../core/utils/misc.js", "../../2d/components/label.js", "./tabIndexUtil.js", "./types.js", "../../core/platform/sys.js", "../../core/platform/visible-rect.js", "./edit-box-impl-base.js", "../../core/global-exports.js", "../../../pal/system-info/enum-type/index.js"], function (_export, _context) {
  "use strict";

  var screenAdapter, BitmapFont, director, game, Mat4, Vec3, view, KeyCode, contains, Label, tabIndexUtil, InputFlag, InputMode, KeyboardReturnType, sys, visibleRect, EditBoxImplBase, legacyCC, BrowserType, OS, SCROLLY, LEFT_PADDING, DELAY_TIME, _matrix, _matrix_temp, _vec3, _currentEditBoxImpl, _domCount, EditBoxImpl;
    ...
    execute: function () {
      ...
      _export("EditBoxImpl", EditBoxImpl = /*#__PURE__*/function (_EditBoxImplBase) {
        ...
        _proto._updateMatrix = function _updateMatrix() {
          ...
          scaleX *= widthRatio;
          scaleY *= heightRatio;
          var viewport = view.getViewportRect(); // TODO: implement editBox in PAL
        ...
        _proto._registerEventListeners = function _registerEventListeners() {
          ...
          cbs.onInput = function () {
            ...
            var delegate = _this3._delegate; // input of number type doesn't support maxLength attribute
