System.register("q-bundled:///fs/cocos/ui/sub-context-view.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "pal/minigame", "pal/screen-adapter", "../core/components/component.js", "../core/platform/view.js", "../2d/components/sprite.js", "../core/scene-graph/index.js", "../2d/framework/ui-transform.js", "../2d/assets/index.js", "../core/assets/image-asset.js", "../core/math/index.js", "../core/global-exports.js", "../core/scene-graph/node-event.js", "../core/index.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, menu, executionOrder, requireComponent, tooltip, serializable, EDITOR, minigame, screenAdapter, Component, view, Sprite, Node, UITransform, SpriteFrame, ImageAsset, Size, legacyCC, NodeEventType, CCObject, Texture2D, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _temp, SubContextView;
    ...
    execute: function () {
      ...
      _export("SubContextView", SubContextView = (_dec = ccclass('cc.SubContextView'), _dec2 = help('i18n:cc.SubContextView'), _dec3 = executionOrder(110), _dec4 = requireComponent(UITransform), _dec5 = menu('Miscellaneous/SubContextView'), _dec6 = tooltip('i18n:subContextView.design_size'), _dec7 = tooltip('i18n:subContextView.fps'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        _proto._updateSubContextView = function _updateSubContextView() {
          ...
          var dpr = screenAdapter.devicePixelRatio; // TODO: the visibleSize need to be the size of Canvas node where the content node is.
