System.register("q-bundled:///fs/cocos/core/pipeline/forward/forward-stage.js", ["../../data/decorators/index.js", "../define.js", "../pass-phase.js", "../render-queue.js", "../../gfx/index.js", "../render-batched-queue.js", "../render-instanced-queue.js", "../render-stage.js", "../enum.js", "../render-additive-light-queue.js", "../../renderer/core/pass.js", "../pipeline-serialization.js", "../planar-shadow-queue.js", "../ui-phase.js", "../pipeline-funcs.js"], function (_export, _context) {
  "use strict";

  var ccclass, displayOrder, type, serializable, SetIndex, getPhaseID, renderQueueClearFunc, convertRenderQueue, renderQueueSortFunc, ClearFlagBit, Color, Rect, RenderBatchedQueue, RenderInstancedQueue, RenderStage, ForwardStagePriority, RenderAdditiveLightQueue, BatchingSchemes, RenderQueueDesc, RenderQueueSortMode, PlanarShadowQueue, UIPhase, renderProfiler, _dec, _dec2, _dec3, _class, _class2, _descriptor, _class3, _temp, colors, ForwardStage;
    ...
    execute: function () {
      ...
      _export("ForwardStage", ForwardStage = (_dec = ccclass('ForwardStage'), _dec2 = type([RenderQueueDesc]), _dec3 = displayOrder(2), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_RenderStage) {
        ...
        _proto.render = function render(camera) {
          ...
          var renderPass = swapchain ? pipeline.getRenderPass(camera.clearFlag & this._clearFlag, swapchain) : framebuffer.renderPass;
