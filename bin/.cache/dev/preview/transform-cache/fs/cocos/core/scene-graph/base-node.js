System.register("q-bundled:///fs/cocos/core/scene-graph/base-node.js", ["../data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../components/component.js", "../data/decorators/property.js", "../data/object.js", "../platform/debug.js", "../utils/id-generator.js", "../utils/js.js", "./base-node-dev.js", "../global-exports.js", "./node-event.js"], function (_export, _context) {
  "use strict";

  var ccclass, editable, serializable, DEV, DEBUG, EDITOR, Component, property, CCObject, errorID, warnID, error, log, getError, IdGenerator, js, baseNodePolyfill, legacyCC, NodeEventType, _dec, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _temp, Destroying, DontDestroy, Deactivating, TRANSFORM_ON, idGenerator, BaseNode;
      ...
      _export("BaseNode", BaseNode = (_dec = ccclass('cc.BaseNode'), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_CCObject) {
        ...
        _proto._onPreDestroyBase = function _onPreDestroyBase() {
          ...
          if (!destroyByParent) {
            // remove from parent
            if (parent) {
              this.emit(NodeEventType.PARENT_CHANGED, this); // During destroy process, sibling index is not reliable
          ...
          this.emit(NodeEventType.NODE_DESTROYED, this); // Destroy node event processor
