System.register("q-bundled:///fs/cocos/core/gfx/webgl2/webgl2-commands.js", ["../../memop/cached-array.js", "../../platform/index.js", "../../platform/debug.js", "../base/define.js", "./webgl2-define.js"], function (_export, _context) {
  "use strict";

  var CachedArray, error, errorID, debug, BufferUsageBit, ColorMask, CullMode, DynamicStateFlagBit, Filter, Format, TextureType, Type, FormatInfos, FormatSize, LoadOp, MemoryUsageBit, SampleCount, ShaderStageFlagBit, TextureFlagBit, Rect, DrawInfo, DynamicStates, UniformSamplerTexture, WebGL2EXT, WebGLWraps, _f32v4, WebGLCmpFuncs, WebGLStencilOps, WebGLBlendOps, WebGLBlendFactors, WebGL2Cmd, WebGL2CmdObject, WebGL2CmdBeginRenderPass, WebGL2CmdBindStates, WebGL2CmdDraw, WebGL2CmdUpdateBuffer, WebGL2CmdCopyBufferToTexture, WebGL2CmdPackage, gfxStateCache, cmdIds;
  ...
  function WebGL2CmdFuncCreateFramebuffer(device, gpuFramebuffer) {
    ...
    if (glFramebuffer) {
      ...
      for (var _i3 = 0; _i3 < gpuFramebuffer.gpuColorTextures.length; ++_i3) {
        var colorTexture = gpuFramebuffer.gpuColorTextures[_i3];

        if (colorTexture) {
          if (colorTexture.glTexture) {
            gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0 + _i3, colorTexture.glTarget, colorTexture.glTexture, 0); // level should be 0.
          } else {
  ...
  function WebGL2CmdFuncCreateShader(device, gpuShader) {
    ...
    for (var _i6 = 0; _i6 < gpuShader.blocks.length; ++_i6) {
      if (gpuShader.blocks[_i6].set === device.bindingMappingInfo.flexibleSet) {
    ...
    for (var _i7 = 0; _i7 < gpuShader.samplerTextures.length; ++_i7) {
      ...
      var _glLoc = gl.getUniformLocation(gpuShader.glProgram, _sampler.name); // wEcHAT just returns { id: -1 } for non-existing names /eyerolling
