System.register("q-bundled:///fs/cocos/core/gfx/pipeline-state.jsb.js", ["./base/define.js"], function (_export, _context) {
  "use strict";

  var BlendFactor, BlendOp, ColorMask, ComparisonFunc, CullMode, PolygonMode, ShadeModel, StencilOp, Color, RasterizerState, DepthStencilState, BlendTarget, BlendState, PipelineState, PipelineStateInfo;
  ...
  function watchArrayElementsField(self, list, eleField, cachedFieldName, callback) {
    var _loop = function _loop(i, l) {
      var ele = list[i];
      var originField = ele[eleField][cachedFieldName] || ele[eleField]; // replace with Proxy
  ...
  return {
    setters: [function (_baseDefineJs) {
      BlendFactor = _baseDefineJs.BlendFactor;
      BlendOp = _baseDefineJs.BlendOp;
      ColorMask = _baseDefineJs.ColorMask;
      ComparisonFunc = _baseDefineJs.ComparisonFunc;
      CullMode = _baseDefineJs.CullMode;
      PolygonMode = _baseDefineJs.PolygonMode;
      ShadeModel = _baseDefineJs.ShadeModel;
      StencilOp = _baseDefineJs.StencilOp;
      Color = _baseDefineJs.Color;
    }],
    execute: function () {
