System.register("q-bundled:///fs/cocos/core/scene-graph/scene.js", ["../data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../data/object.js", "../math/index.js", "../platform/debug.js", "./base-node.js", "../global-exports.js", "./scene-globals.js", "../utils/prefab/utils.js", "../renderer/scene/native-scene.js"], function (_export, _context) {
  "use strict";

  var ccclass, serializable, editable, EDITOR, JSB, TEST, CCObject, Mat4, Quat, Vec3, assert, getError, BaseNode, legacyCC, SceneGlobals, applyTargetOverrides, expandNestedPrefabInstanceNode, NativeScene, _dec, _class, _class2, _descriptor, _descriptor2, _temp, Scene;
  ...
  return {
    setters: [function (_dataDecoratorsIndexJs) {
      ...
      expandNestedPrefabInstanceNode = _utilsPrefabUtilsJs.expandNestedPrefabInstanceNode;
    }, function (_rendererSceneNativeSceneJs) {
      NativeScene = _rendererSceneNativeSceneJs.NativeScene;
    }],
    execute: function () {
      /**
       * @en
