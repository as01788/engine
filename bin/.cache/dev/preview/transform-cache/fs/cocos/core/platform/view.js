System.register("q-bundled:///fs/cocos/core/platform/view.js", ["../data/class.js", "../../../../virtual/internal%253Aconstants.js", "pal/screen-adapter", "../event/index.js", "../math/index.js", "./visible-rect.js", "../global-exports.js", "./debug.js", "./screen.js", "./macro.js", "../../../pal/screen-adapter/enum-type/index.js", "../game.js"], function (_export, _context) {
  "use strict";

  var MINIGAME, JSB, RUNTIME_BASED, screenAdapter, EventTarget, Rect, Size, Vec2, visibleRect, legacyCC, errorID, screen, macro, Orientation, game, _orientationMap, localWinSize, orientationMap, View, ContainerStrategy, ContentStrategy, ResolutionPolicy, view;
    ...
    execute: function () {
      ...
      _export("View", View = /*#__PURE__*/function (_EventTarget) {
        ...
        function View() {
          ...
          var _strategy = ContentStrategy; // resolution size, it is the size appropriate for the app resources.
          ...
          _this._autoFullScreen = false; // Retina disabled by default

          _this._retinaEnabled = false; // Custom callback for resize event

          _this._resizeCallback = null; // Setup system default resolution policies
        ...
        _proto.adjustViewportMeta = function adjustViewportMeta(enabled) {// DO NOTHING
        }
        /**
         * @en
        ...
        _proto.setCanvasSize = function setCanvasSize(width, height) {
          ...
          screenAdapter.resolutionScale = 1; // set window size
        ...
        _proto._updateAdaptResult = function _updateAdaptResult() {
          ...
          legacyCC.director.root.resize(screen.windowSize.width, screen.windowSize.height); // Frame size changed, do resize works
