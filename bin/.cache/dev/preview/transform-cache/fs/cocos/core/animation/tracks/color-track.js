System.register("q-bundled:///fs/cocos/core/animation/tracks/color-track.js", ["../../data/decorators/index.js", "../../curves/index.js", "../../math/index.js", "../define.js", "./track.js", "./utils.js"], function (_export, _context) {
  "use strict";

  var ccclass, serializable, RealCurve, Color, CLASS_NAME_PREFIX_ANIM, createEvalSymbol, Channel, Track, maskIfEmpty, _dec, _class, _class2, _descriptor, _temp, CHANNEL_NAMES, ColorTrack, ColorTrackEval;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ColorTrack", ColorTrack = (_dec = ccclass(CLASS_NAME_PREFIX_ANIM + "ColorTrack"), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Track) {
