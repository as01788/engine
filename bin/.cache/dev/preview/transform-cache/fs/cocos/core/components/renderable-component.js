System.register("q-bundled:///fs/cocos/core/components/renderable-component.js", ["../../../../virtual/internal%253Aconstants.js", "../data/decorators/index.js", "../assets/material.js", "./component.js", "../renderer/core/material-instance.js", "../scene-graph/layers.js", "../platform/debug.js", "../global-exports.js"], function (_export, _context) {
  "use strict";

  var EDITOR, ccclass, type, displayOrder, displayName, serializable, Material, Component, MaterialInstance, Layers, warnID, legacyCC, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _temp, _matInsInfo, RenderableComponent;
    ...
    execute: function () {
      ...
      _export("RenderableComponent", RenderableComponent = (_dec = ccclass('cc.RenderableComponent'), _dec2 = type([Material]), _dec3 = type(Material), _dec4 = displayOrder(0), _dec5 = displayName('Materials'), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        _proto.setMaterialInstance = function setMaterialInstance(matInst, index) {
          ...
          var curInst = this._materialInstances[index]; // If the new material is an MaterialInstance
