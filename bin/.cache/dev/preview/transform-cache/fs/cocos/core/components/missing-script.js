System.register("q-bundled:///fs/cocos/core/components/missing-script.js", ["../data/decorators/index.js", "../utils/js.js", "./component.js", "../global-exports.js", "../platform/debug.js"], function (_export, _context) {
  ...
  var ccclass, inspector, editorOnly, serializable, _getClassById, Component, legacyCC, warnID, error, _dec, _dec2, _class, _class2, _descriptor, _temp, MissingScript, props;
  ...
  return {
    ...
    execute: function () {
      ...
      legacyCC._MissingScript = MissingScript; // DEBUG: Check MissingScript class for issue 9878
      ...
      try {
        ...
        if (props.length === 0 || props[props.length - 1] !== '_$erialized') {
          ...
          error("    Error props: ['" + props + "']"); // props.push('_$erialized');
        }
      } catch (e) {
