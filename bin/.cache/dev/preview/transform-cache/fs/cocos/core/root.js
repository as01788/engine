System.register("q-bundled:///fs/cocos/core/root.js", ["../../../virtual/internal%253Aconstants.js", "./builtin/index.js", "./memop/index.js", "./pipeline/index.js", "./renderer/scene/index.js", "./renderer/scene/light.js", "./renderer/scene/render-scene.js", "./global-exports.js", "./renderer/core/render-window.js", "./gfx/index.js", "./platform/debug.js"], function (_export, _context) {
  "use strict";

  var JSB, builtinResMgr, Pool, createDefaultPipeline, DeferredPipeline, Camera, NativeRoot, LightType, RenderScene, legacyCC, RenderWindow, ColorAttachment, DepthStencilAttachment, RenderPassInfo, StoreOp, Feature, warnID, Root;
  ...
  return {
    setters: [function (_virtualInternal253AconstantsJs) {
      ...
      NativeRoot = _rendererSceneIndexJs.NativeRoot;
    ...
    execute: function () {
      ...
      _export("Root", Root = /*#__PURE__*/function () {
        ...
        _proto.setRenderPipeline = function setRenderPipeline(rppl) {
          ...
          this._pipeline = rppl; // now cluster just enabled in deferred pipeline
