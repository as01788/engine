System.register("q-bundled:///fs/cocos/core/asset-manager/downloader.js", ["../../../../virtual/internal%253Aconstants.js", "../platform/sys.js", "../utils/index.js", "../utils/misc.js", "../utils/path.js", "./cache.js", "./download-dom-image.js", "./download-file.js", "./download-script.js", "./shared.js", "./utilities.js", "../global-exports.js", "../data/ccon.js"], function (_export, _context) {
  "use strict";

  var BUILD, EDITOR, sys, js, path, callInNextTick, basename, Cache, downloadDomImage, downloadFile, downloadScript, files, retry, urlAppendTimestamp, legacyCC, CCON, parseCCONJson, decodeCCONBinary, REGEX, downloadImage, downloadBlob, downloadJson, downloadArrayBuffer, downloadCCON, downloadCCONB, downloadText, downloadBundle, Downloader, downloader;
  ...
  return {
    ...
    }, function (_dataCconJs) {
      CCON = _dataCconJs.CCON;
      parseCCONJson = _dataCconJs.parseCCONJson;
      decodeCCONBinary = _dataCconJs.decodeCCONBinary;
    }],
    execute: function () {
      REGEX = /^(?:\w+:\/\/|\.+\/).+/;
        ...
        downloadJson(url, options, function (err, json) {
          ...
          var chunkPromises = Promise.all(cconPreface.chunks.map(function (chunk) {
            return new Promise(function (resolve, reject) {
              downloadArrayBuffer("" + path.mainFileName(url) + chunk, {}, function (errChunk, chunkBuffer) {
                if (err) {
                  reject(err);
                } else {
      ...
      _export("Downloader", Downloader = /*#__PURE__*/function () {
        ...
        _proto._updateTime = function _updateTime() {
          var now = performance.now(); // use deltaTime as interval
