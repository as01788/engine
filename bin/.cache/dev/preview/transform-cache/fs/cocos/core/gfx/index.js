System.register("q-bundled:///fs/cocos/core/gfx/index.js", ["./polyfill-legacy-cc.js", "./deprecated-3.0.0.js", "./base/descriptor-set.js", "./base/buffer.js", "./base/command-buffer.js", "./base/define.js", "./base/device.js", "./base/swapchain.js", "./base/framebuffer.js", "./base/input-assembler.js", "./base/descriptor-set-layout.js", "./base/pipeline-layout.js", "./base/pipeline-state.js", "./base/queue.js", "./base/render-pass.js", "./base/states/sampler.js", "./base/shader.js", "./base/texture.js", "./base/states/global-barrier.js", "./base/states/texture-barrier.js"], function (_export, _context) {
  "use strict";

  return {
    setters: [function (_polyfillLegacyCcJs) {}, function (_deprecated300Js) {}, function (_baseDescriptorSetJs) {
      var _exportObj = {};
      ...
      for (var _key11 in _basePipelineStateJs) {
        if (_key11 !== "default" && _key11 !== "__esModule") _exportObj11[_key11] = _basePipelineStateJs[_key11];
      }
      ...
      for (var _key14 in _baseStatesSamplerJs) {
        if (_key14 !== "default" && _key14 !== "__esModule") _exportObj14[_key14] = _baseStatesSamplerJs[_key14];
      }
      ...
      for (var _key15 in _baseShaderJs) {
        if (_key15 !== "default" && _key15 !== "__esModule") _exportObj15[_key15] = _baseShaderJs[_key15];
      }
      ...
      for (var _key16 in _baseTextureJs) {
        if (_key16 !== "default" && _key16 !== "__esModule") _exportObj16[_key16] = _baseTextureJs[_key16];
      }
      ...
      for (var _key17 in _baseStatesGlobalBarrierJs) {
        if (_key17 !== "default" && _key17 !== "__esModule") _exportObj17[_key17] = _baseStatesGlobalBarrierJs[_key17];
      }
