System.register("q-bundled:///fs/cocos/core/math/mat4.jsb.js", ["../data/class.js", "./mat3.jsb.js", "./quat.jsb.js", "./utils.js", "./vec3.jsb.js", "../global-exports.js", "./math-base.js"], function (_export, _context) {
  "use strict";

  var CCClass, Mat3, Quat, enumerableProps, EPSILON, Vec3, legacyCC, MathBase, preTransforms, Mat4, v3_1, m3_1;
  ...
  return {
    setters: [function (_dataClassJs) {
      ...
      Mat3 = _mat3JsbJs.Mat3;
    }, function (_quatJsbJs) {
      Quat = _quatJsbJs.Quat;
    }, function (_utilsJs) {
    ...
    execute: function () {
       ...
       * @zh 表示四维（4x4）矩阵。
       */
      _export("Mat4", Mat4 = /*#__PURE__*/function (_MathBase) {
        ...
        _proto.multiply = function multiply(mat) {
          ...
          var a32 = this._array[14];
          var a33 = this._array[15];
          var v = mat.array; // Cache only the current line of the second matrix
        ...
        _proto.rotate = function rotate(rad, axis) {
          ...
          var a21 = this._array[9];
          var a22 = this._array[10];
          var a23 = this._array[11]; // Construct the elements of the rotation matrix
