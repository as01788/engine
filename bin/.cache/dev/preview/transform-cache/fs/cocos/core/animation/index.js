System.register("q-bundled:///fs/cocos/core/animation/index.js", ["../data/decorators/index.js", "./animation.js", "./easing.js", "./target-path.js", "./value-proxy-factories/uniform.js", "../global-exports.js", "./deprecated.js", "./bezier.js", "./animation-curve.js", "./animation-clip.js", "./animation-manager.js", "./animation-state.js", "./animation-component.js", "./transform-utils.js", "./cubic-spline-value.js"], function (_export, _context) {
  ...
  return {
    setters: [function (_dataDecoratorsIndexJs) {
      ...
      for (var _key4 in _animationManagerJs) {
        if (_key4 !== "default" && _key4 !== "__esModule") _exportObj4[_key4] = _animationManagerJs[_key4];
      }
      ...
      for (var _key5 in _animationComponentJs) {
        if (_key5 !== "default" && _key5 !== "__esModule") _exportObj5[_key5] = _animationComponentJs[_key5];
      }
      ...
      for (var _key6 in _transformUtilsJs) {
        if (_key6 !== "default" && _key6 !== "__esModule") _exportObj6[_key6] = _transformUtilsJs[_key6];
      }
      ...
      for (var _key7 in _cubicSplineValueJs) {
        if (_key7 !== "default" && _key7 !== "__esModule") _exportObj7[_key7] = _cubicSplineValueJs[_key7];
      }
