System.register("q-bundled:///fs/cocos/core/gfx/webgl/webgl-command-buffer.js", ["../base/command-buffer.js", "./webgl-command-allocator.js", "../base/define.js", "./webgl-commands.js", "./webgl-define.js"], function (_export, _context) {
  "use strict";

  var CommandBuffer, WebGLCommandAllocator, BufferUsageBit, CommandBufferType, StencilFace, DynamicStates, WebGLCmd, WebGLCmdBeginRenderPass, WebGLCmdBindStates, WebGLCmdCopyBufferToTexture, WebGLCmdDraw, WebGLCmdPackage, WebGLCmdUpdateBuffer, WebGLDeviceManager, WebGLCommandBuffer;
    ...
    execute: function () {
      _export("WebGLCommandBuffer", WebGLCommandBuffer = /*#__PURE__*/function (_CommandBuffer) {
        ...
        _proto.initialize = function initialize(info) {
          ...
          var setCount = WebGLDeviceManager.instance.bindingMappingInfo.bufferOffsets.length;
