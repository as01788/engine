System.register("q-bundled:///fs/cocos/core/pipeline/deferred/main-flow.js", ["../../data/decorators/index.js", "../define.js", "../render-flow.js", "../enum.js", "./gbuffer-stage.js", "./lighting-stage.js", "./postprocess-stage.js", "./bloom-stage.js"], function (_export, _context) {
  "use strict";

  var ccclass, PIPELINE_FLOW_MAIN, RenderFlow, DeferredFlowPriority, GbufferStage, LightingStage, PostProcessStage, BloomStage, _dec, _class, _class2, _temp, MainFlow;
  ...
  return {
    ...
    execute: function () {
       ...
       * @zh 延迟渲染流程。
       */
      _export("MainFlow", MainFlow = (_dec = ccclass('MainFlow'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_RenderFlow) {
