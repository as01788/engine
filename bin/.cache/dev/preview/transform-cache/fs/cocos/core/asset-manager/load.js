System.register("q-bundled:///fs/cocos/core/asset-manager/load.js", ["../../../../virtual/internal%253Aconstants.js", "../assets/index.js", "../platform/debug.js", "./pack-manager.js", "./parser.js", "./pipeline.js", "./shared.js", "./task.js", "./utilities.js", "../global-exports.js", "./depend-maps.js"], function (_export, _context) {
  "use strict";

  var BUILD, EDITOR, PREVIEW, Asset, SceneAsset, error, packManager, parser, Pipeline, assets, files, parsed, pipeline, Task, cache, checkCircleReference, clear, forEach, gatherAsset, getDepends, setProperties, legacyCC, nativeDependMap, onLoadedInvokedMap, loadOneAssetPipeline;
