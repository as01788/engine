System.register("q-bundled:///fs/cocos/core/assets/asset.js", ["../data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../data/decorators/property.js", "../asset-manager/helper.js", "../event/index.js", "../data/gc-object.js", "../global-exports.js", "../utils/path.js", "../platform/debug.js"], function (_export, _context) {
  "use strict";

  var ccclass, serializable, EDITOR, PREVIEW, property, getUrlWithUuid, Eventify, GCObject, legacyCC, extname, debug, getError, _dec, _class, _class2, _descriptor, _temp, Asset;
  ...
  return {
    setters: [function (_dataDecoratorsIndexJs) {
      ...
      GCObject = _dataGcObjectJs.GCObject;
    ...
    execute: function () {
      ...
      _export("Asset", Asset = (_dec = ccclass('cc.Asset'), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Eventify) {
        ...
        return Asset;
      }(Eventify(GCObject)), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_native", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
