System.register("q-bundled:///fs/cocos/core/gfx/base/pipeline-state.js", ["./define.js"], function (_export, _context) {
  "use strict";

  var BlendFactor, BlendOp, ColorMask, ComparisonFunc, CullMode, DynamicStateFlagBit, GFXObject, ObjectType, PolygonMode, PrimitiveMode, ShadeModel, StencilOp, InputState, Color, PipelineBindPoint, RasterizerState, DepthStencilState, BlendTarget, BlendState, PipelineStateInfo, PipelineState;
    ...
    execute: function () {
      ...
      _export("RasterizerState", RasterizerState = /*#__PURE__*/function () {
        ...
        _createClass(RasterizerState, [{
          key: "native",
          get: // to make sure all usages must be an instance of this exact class, not assembled from plain object
          function get() {
            return this;
          }
        }]);
