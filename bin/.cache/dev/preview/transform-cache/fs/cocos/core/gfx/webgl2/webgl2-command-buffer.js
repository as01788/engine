System.register("q-bundled:///fs/cocos/core/gfx/webgl2/webgl2-command-buffer.js", ["../base/command-buffer.js", "../base/define.js", "./webgl2-command-allocator.js", "./webgl2-commands.js", "./webgl2-define.js"], function (_export, _context) {
  "use strict";

  var CommandBuffer, BufferUsageBit, CommandBufferType, StencilFace, DynamicStates, WebGL2CommandAllocator, WebGL2Cmd, WebGL2CmdBeginRenderPass, WebGL2CmdBindStates, WebGL2CmdCopyBufferToTexture, WebGL2CmdDraw, WebGL2CmdPackage, WebGL2CmdUpdateBuffer, WebGL2DeviceManager, WebGL2CommandBuffer;
    ...
    execute: function () {
      _export("WebGL2CommandBuffer", WebGL2CommandBuffer = /*#__PURE__*/function (_CommandBuffer) {
        ...
        _proto.initialize = function initialize(info) {
          ...
          var setCount = WebGL2DeviceManager.instance.bindingMappingInfo.bufferOffsets.length;
        ...
        _proto.pipelineBarrier = function pipelineBarrier(globalBarrier, textureBarriers, textures) {};
