System.register("q-bundled:///fs/cocos/3d/lights/spot-light-component.js", ["../../core/data/decorators/index.js", "../../core/math/index.js", "../../core/renderer/index.js", "./light-component.js", "../../core/global-exports.js", "../../core/renderer/scene/index.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, executeInEditMode, menu, tooltip, type, slide, range, serializable, formerlySerializedAs, toRadian, scene, Light, PhotometricTerm, legacyCC, Camera, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _temp, SpotLight;
  ...
  return {
    ...
    execute: function () {
      _export("SpotLight", SpotLight = (_dec = ccclass('cc.SpotLight'), _dec2 = help('i18n:cc.SpotLight'), _dec3 = menu('Light/SpotLight'), _dec4 = formerlySerializedAs('_luminance'), _dec5 = tooltip('i18n:lights.luminous_flux'), _dec6 = tooltip('i18n:lights.luminance'), _dec7 = type(PhotometricTerm), _dec8 = tooltip('i18n:lights.term'), _dec9 = tooltip('i18n:lights.size'), _dec10 = tooltip('i18n:lights.range'), _dec11 = range([2, 180, 1]), _dec12 = tooltip('The spot light cone angle'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Light) {
        ...
        function SpotLight() {
          ...
          _initializerDefineProperty(_this, "_spotAngle", _descriptor6, _assertThisInitialized(_this));
