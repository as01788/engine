System.register("q-bundled:///fs/cocos/3d/models/baked-skinning-model.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/gfx/index.js", "../../core/pipeline/define.js", "../../core/renderer/scene/model.js", "../skeletal-animation/skeletal-animation-utils.js", "./morph-model.js", "../../core/global-exports.js", "../../core/renderer/scene/native-scene.js"], function (_export, _context) {
  "use strict";

  var JSB, BufferUsageBit, MemoryUsageBit, BufferInfo, INST_JOINT_ANIM_INFO, UBOSkinningAnimation, UBOSkinningTexture, UNIFORM_JOINT_TEXTURE_BINDING, ModelType, jointTextureSamplerInfo, MorphModel, legacyCC, NativeBakedSkinningModel, myPatches, BakedSkinningModel;
  ...
  return {
    setters: [function (_virtualInternal253AconstantsJs) {
      ...
      jointTextureSamplerInfo = _skeletalAnimationSkeletalAnimationUtilsJs.jointTextureSamplerInfo;
    }, function (_morphModelJs) {
      MorphModel = _morphModelJs.MorphModel;
    }, function (_coreGlobalExportsJs) {
      legacyCC = _coreGlobalExportsJs.legacyCC;
    }, function (_coreRendererSceneNativeSceneJs) {
      NativeBakedSkinningModel = _coreRendererSceneNativeSceneJs.NativeBakedSkinningModel;
    }],
    execute: function () {
      myPatches = [{
        ...
        _proto._applyNativeJointMedium = function _applyNativeJointMedium() {
          if (JSB && this._nativeObj) {
            ...
            if (this._jointsMedium.boundsInfo) {
              this._jointsMedium.boundsInfo.forEach(function (bound) {
                boundsInfo.push(bound["native"]);
              });
            }

            var animInfoKey = 'nativeDirty';
