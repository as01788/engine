System.register("q-bundled:///fs/cocos/3d/skeletal-animation/skeletal-animation-blending.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/math/index.js"], function (_export, _context) {
  "use strict";

  var DEBUG, Vec3, Quat, BlendStateBuffer, BlendStateWriterInternal, PropertyBlendState, Vec3PropertyBlendState, QuatPropertyBlendState, NodeBlendState;
    ...
    execute: function () {
      ...
      Vec3PropertyBlendState = /*#__PURE__*/function (_PropertyBlendState) {
        ...
        _proto3.blend = function blend(value, weight) {
          ...
          if (DEBUG && this.blendedWeight > 1.0) {// assertIsTrue(approx(this.blendedWeight, 1.0, 1e-6));
          }
        };
