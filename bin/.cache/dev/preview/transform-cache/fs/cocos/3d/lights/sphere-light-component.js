System.register("q-bundled:///fs/cocos/3d/lights/sphere-light-component.js", ["../../core/data/decorators/index.js", "../../core/renderer/index.js", "./light-component.js", "../../core/global-exports.js", "../../core/renderer/scene/index.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, executeInEditMode, menu, tooltip, type, serializable, formerlySerializedAs, scene, Light, PhotometricTerm, legacyCC, Camera, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _temp, SphereLight;
  ...
  return {
    ...
    execute: function () {
      _export("SphereLight", SphereLight = (_dec = ccclass('cc.SphereLight'), _dec2 = help('i18n:cc.SphereLight'), _dec3 = menu('Light/SphereLight'), _dec4 = formerlySerializedAs('_luminance'), _dec5 = tooltip('i18n:lights.luminous_flux'), _dec6 = tooltip('i18n:lights.luminance'), _dec7 = type(PhotometricTerm), _dec8 = tooltip('i18n:lights.term'), _dec9 = tooltip('i18n:lights.size'), _dec10 = tooltip('i18n:lights.range'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Light) {
        ...
        function SphereLight() {
          ...
          _initializerDefineProperty(_this, "_luminanceHDR", _descriptor2, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "_luminanceLDR", _descriptor3, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "_term", _descriptor4, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "_range", _descriptor5, _assertThisInitialized(_this));
