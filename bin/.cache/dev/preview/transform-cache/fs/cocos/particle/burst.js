System.register("q-bundled:///fs/cocos/particle/burst.js", ["../core/data/decorators/index.js", "../core/math/index.js", "./animator/curve-range.js"], function (_export, _context) {
  ...
  var ccclass, type, serializable, editable, range, repeat, CurveRange, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, Burst;
  ...
  return {
    ...
    execute: function () {
      _export("default", Burst = (_dec = ccclass('cc.Burst'), _dec2 = type(CurveRange), _dec3 = range([0, 1]), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function () {
        function Burst() {
