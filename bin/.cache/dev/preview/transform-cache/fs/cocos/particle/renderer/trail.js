System.register("q-bundled:///fs/cocos/particle/renderer/trail.js", ["../../core/data/decorators/index.js", "../../core/assets/rendering-sub-mesh.js", "../../core/director.js", "../../core/gfx/index.js", "../../core/math/index.js", "../../core/memop/index.js", "../../core/renderer/index.js", "../animator/curve-range.js", "../animator/gradient-range.js", "../enum.js", "../../core/global-exports.js", "../../core/scene-graph/node-enum.js"], function (_export, _context) {
  "use strict";

  var ccclass, tooltip, displayOrder, type, serializable, range, RenderingSubMesh, director, AttributeName, BufferUsageBit, Format, FormatInfos, MemoryUsageBit, PrimitiveMode, Attribute, IndirectBuffer, BufferInfo, DrawInfo, DRAW_INFO_SIZE, Color, Mat4, Quat, toRadian, Vec3, Pool, scene, CurveRange, GradientRange, Space, TextureMode, TrailMode, legacyCC, TransformBit, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _temp, PRE_TRIANGLE_INDEX, NEXT_TRIANGLE_INDEX, DIRECTION_THRESHOLD, _temp_trailEle, _temp_quat, _temp_xform, _temp_vec3, _temp_vec3_1, _temp_color, TrailSegment, TrailModule;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", TrailModule = (_dec = ccclass('cc.TrailModule'), _dec2 = displayOrder(0), _dec3 = type(TrailMode), _dec4 = displayOrder(1), _dec5 = tooltip('i18n:trailSegment.mode'), _dec6 = type(CurveRange), _dec7 = range([0, 1]), _dec8 = displayOrder(3), _dec9 = tooltip('i18n:trailSegment.lifeTime'), _dec10 = displayOrder(5), _dec11 = tooltip('i18n:trailSegment.minParticleDistance'), _dec12 = type(Space), _dec13 = displayOrder(6), _dec14 = tooltip('i18n:trailSegment.space'), _dec15 = type(TextureMode), _dec16 = displayOrder(8), _dec17 = tooltip('i18n:trailSegment.textureMode'), _dec18 = displayOrder(9), _dec19 = tooltip('i18n:trailSegment.widthFromParticle'), _dec20 = type(CurveRange), _dec21 = range([0, 1]), _dec22 = displayOrder(10), _dec23 = tooltip('i18n:trailSegment.widthRatio'), _dec24 = displayOrder(11), _dec25 = tooltip('i18n:trailSegment.colorFromParticle'), _dec26 = type(GradientRange), _dec27 = displayOrder(12), _dec28 = tooltip('i18n:trailSegment.colorOverTrail'), _dec29 = type(GradientRange), _dec30 = displayOrder(13), _dec31 = tooltip('i18n:trailSegment.colorOvertime'), _dec32 = type(Space), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function () {
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "minParticleDistance", [_dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "minParticleDistance"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "space", [_dec12, _dec13, _dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "space"), _class2.prototype), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "existWithParticles", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "textureMode", [_dec15, serializable, _dec16, _dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "widthFromParticle", [serializable, _dec18, _dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "widthRatio", [_dec20, serializable, _dec21, _dec22, _dec23], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "colorFromParticle", [serializable, _dec24, _dec25], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "colorOverTrail", [_dec26, serializable, _dec27, _dec28], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "colorOvertime", [_dec29, serializable, _dec30, _dec31], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
