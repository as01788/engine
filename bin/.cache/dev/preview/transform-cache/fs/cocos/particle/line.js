System.register("q-bundled:///fs/cocos/particle/line.js", ["../core/data/decorators/index.js", "../core/assets/index.js", "../core/components/index.js", "../core/math/index.js", "./models/line-model.js", "../core/builtin/index.js", "./animator/curve-range.js", "./animator/gradient-range.js", "../core/global-exports.js", "../core/renderer/core/material-instance.js"], function (_export, _context) {
  ...
  var ccclass, help, executeInEditMode, menu, tooltip, displayOrder, type, serializable, range, Material, Texture2D, Component, Vec3, Vec2, Vec4, LineModel, builtinResMgr, CurveRange, GradientRange, legacyCC, MaterialInstance, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _temp, _matInsInfo, CC_USE_WORLD_SPACE, define, Line;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Line", Line = (_dec = ccclass('cc.Line'), _dec2 = help('i18n:cc.Line'), _dec3 = menu('Effects/Line'), _dec4 = type(Texture2D), _dec5 = type(Texture2D), _dec6 = displayOrder(0), _dec7 = tooltip('i18n:line.texture'), _dec8 = displayOrder(1), _dec9 = tooltip('i18n:line.worldSpace'), _dec10 = type([Vec3]), _dec11 = type([Vec3]), _dec12 = displayOrder(2), _dec13 = tooltip('i18n:line.positions'), _dec14 = type(CurveRange), _dec15 = type(CurveRange), _dec16 = range([0, 1]), _dec17 = displayOrder(3), _dec18 = tooltip('i18n:line.width'), _dec19 = type(Vec2), _dec20 = displayOrder(4), _dec21 = tooltip('i18n:line.tile'), _dec22 = type(Vec2), _dec23 = displayOrder(5), _dec24 = tooltip('i18n:line.offset'), _dec25 = type(GradientRange), _dec26 = type(GradientRange), _dec27 = displayOrder(6), _dec28 = tooltip('i18n:line.color'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "width", [_dec15, _dec16, _dec17, _dec18], Object.getOwnPropertyDescriptor(_class2.prototype, "width"), _class2.prototype), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "_tile", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "tile", [_dec19, _dec20, _dec21], Object.getOwnPropertyDescriptor(_class2.prototype, "tile"), _class2.prototype), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "_offset", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
