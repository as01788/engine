System.register("q-bundled:///fs/cocos/particle/renderer/particle-system-renderer-cpu.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/builtin/index.js", "../../core/gfx/index.js", "../../core/math/index.js", "../../core/memop/index.js", "../../core/renderer/core/material-instance.js", "../enum.js", "../particle.js", "./particle-system-renderer-base.js"], function (_export, _context) {
  "use strict";

  var EDITOR, builtinResMgr, AttributeName, Format, Attribute, Mat4, Vec2, Vec3, Vec4, pseudoRandom, Quat, RecyclePool, MaterialInstance, AlignmentSpace, RenderMode, Space, Particle, PARTICLE_MODULE_ORDER, ParticleSystemRendererBase, _tempAttribUV, _tempWorldTrans, _node_rot, _node_euler, _anim_module, _uvs, CC_USE_WORLD_SPACE, CC_RENDER_MODE, ROTATION_OVER_TIME_MODULE_ENABLE, RENDER_MODE_BILLBOARD, RENDER_MODE_STRETCHED_BILLBOARD, RENDER_MODE_HORIZONTAL_BILLBOARD, RENDER_MODE_VERTICAL_BILLBOARD, RENDER_MODE_MESH, _vertex_attrs, _vertex_attrs_stretch, _vertex_attrs_mesh, _matInsInfo, ParticleSystemRendererCPU;
          ...
          if (this._alignSpace === AlignmentSpace.Local) {
            ...
            if (cameraLst !== undefined) {
              for (var i = 0; i < (cameraLst === null || cameraLst === void 0 ? void 0 : cameraLst.length); ++i) {
                var camera = cameraLst[i]; // eslint-disable-next-line max-len

                var checkCamera = !EDITOR ? (camera.visibility & this._particleSystem.node.layer) === this._particleSystem.node.layer : camera.name === 'Editor Camera';
