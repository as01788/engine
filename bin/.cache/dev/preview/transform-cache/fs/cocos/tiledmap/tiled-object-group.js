System.register("q-bundled:///fs/cocos/tiledmap/tiled-object-group.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../core/components/index.js", "../2d/components/sprite.js", "../2d/components/label.js", "../core/gfx/index.js", "./tiled-types.js", "../2d/framework/ui-transform.js", "../core/index.js", "../2d/assets/index.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, type, requireComponent, UI_GPU_DRIVEN, Component, Sprite, Label, BlendFactor, TileFlag, Orientation, StaggerAxis, TMXObjectType, UITransform, CCBoolean, Node, Vec2, Color, CCObject, SpriteFrame, _dec, _dec2, _dec3, _dec4, _class, _class2, _temp, TiledObjectGroup;
        ...
        _proto._init = function _init(groupInfo, mapInfo, texGrids) {
          ...
          for (var i = 0, l = objects.length; i < l; i++) {
            ...
            if (objType === TMXObjectType.TEXT) {
              ...
              sprite.sizeMode = Sprite.SizeMode.CUSTOM; // @ts-expect-error remove when component remove blend function

              sprite._srcBlendFactor = this._premultiplyAlpha ? BlendFactor.ONE : BlendFactor.SRC_ALPHA; // @ts-expect-error remove when component remove blend function
