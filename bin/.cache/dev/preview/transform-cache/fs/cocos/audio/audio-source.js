System.register("q-bundled:///fs/cocos/audio/audio-source.js", ["pal/audio", "../core/data/decorators/index.js", "../../pal/audio/type.js", "../core/components/component.js", "../core/math/index.js", "./audio-clip.js", "./audio-manager.js"], function (_export, _context) {
  "use strict";

  var AudioPlayer, ccclass, help, menu, tooltip, type, range, serializable, AudioState, Component, clamp, AudioClip, audioManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _temp, AudioSourceEventType, AudioSource;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioSource", AudioSource = (_dec = ccclass('cc.AudioSource'), _dec2 = help('i18n:cc.AudioSource'), _dec3 = menu('Audio/AudioSource'), _dec4 = type(AudioClip), _dec5 = type(AudioClip), _dec6 = tooltip('i18n:audio.clip'), _dec7 = tooltip('i18n:audio.loop'), _dec8 = tooltip('i18n:audio.playOnAwake'), _dec9 = range([0.0, 1.0]), _dec10 = tooltip('i18n:audio.volume'), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
        ...
        return AudioSource;
      }(Component), _class3.AudioState = AudioState, _class3.EventType = AudioSourceEventType, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_clip", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
