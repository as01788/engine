System.register("q-bundled:///fs/cocos/audio/audio-clip.js", ["../core/data/decorators/index.js", "pal/audio", "../core/assets/asset.js", "../core/global-exports.js", "../../pal/audio/type.js", "../../pal/audio/web/player-web.js"], function (_export, _context) {
  "use strict";

  var ccclass, serializable, override, AudioPlayer, Asset, legacyCC, AudioState, AudioType, AudioPlayerWeb, _dec, _class, _class2, _descriptor, _class3, _temp, AudioClip;
  ...
  return {
    ...
    }, function (_palAudioWebPlayerWebJs) {
      AudioPlayerWeb = _palAudioWebPlayerWebJs.AudioPlayerWeb;
    }],
    execute: function () {
      /**
       * @en
      ...
      _export("AudioClip", AudioClip = (_dec = ccclass('cc.AudioClip'), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Asset) {
        ...
        _proto.loadAudioPlayerWeb = function loadAudioPlayerWeb(audioBuffer, url) {
          return new AudioPlayerWeb(audioBuffer, url);
        };
