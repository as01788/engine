System.register("q-bundled:///fs/cocos/video/video-player-impl-web.js", ["pal/screen-adapter", "../core/math/index.js", "../core/platform/index.js", "../core/index.js", "../core/utils/misc.js", "./video-player-enums.js", "./video-player-impl.js", "../core/gfx/index.js", "../core/platform/visible-rect.js", "../../pal/system-info/enum-type/index.js"], function (_export, _context) {
  "use strict";

  var screenAdapter, mat4, sys, screen, warn, game, contains, EventType, READY_STATE, VideoPlayerImpl, ClearFlagBit, visibleRect, BrowserType, OS, MIN_ZINDEX, _mat4_temp, VideoPlayerImplWeb;
    ...
    execute: function () {
      ...
      _export("VideoPlayerImplWeb", VideoPlayerImplWeb = /*#__PURE__*/function (_VideoPlayerImpl) {
        ...
        _proto.syncMatrix = function syncMatrix() {
          ...
          this._w = width;
          this._h = height; // TODO: implement videoPlayer in PAL
